 ...
 */
@XmlType(name = "actions", namespace = "http://usertracking.opencast.org")
@XmlRootElement(name = "actions", namespace = "http://usertracking.opencast.org")
...
public class UserActionListImpl implements UserActionList {
  ...
  @XmlElement(name = "action", namespace = "http://usertracking.opencast.org")
