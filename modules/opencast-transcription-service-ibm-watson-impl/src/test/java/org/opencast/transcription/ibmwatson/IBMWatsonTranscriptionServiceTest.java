...
import org.opencast.transcription.ibmwatson.IBMWatsonTranscriptionService.WorkflowDispatcher;
...
import org.opencast.util.persistence.PersistenceUtil;
...
public class IBMWatsonTranscriptionServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    EasyMock.expect(bc.getProperty("org.opencast.security.digest.user")).andReturn("matterhorn_system_account");
    ...
    database.setEntityManagerFactory(
            PersistenceUtil.newTestEntityManagerFactory("org.opencast.transcription.ibmwatson.persistence"));
