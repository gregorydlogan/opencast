...
package org.opencast.workflow.handler.videoeditor;
...
import org.opencast.mediapackage.selector.TrackSelector;
...
import org.opencast.workflow.handler.workflow.ResumableWorkflowOperationHandlerBase;
...
public class VideoEditorWorkflowOperationHandler extends ResumableWorkflowOperationHandlerBase {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.AbstractWorkflowOperationHandler#skip(org.opencast.workflow.api.WorkflowInstance,
   *      JobContext)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.ResumableWorkflowOperationHandler#resume(org.opencast.workflow.api.WorkflowInstance,
