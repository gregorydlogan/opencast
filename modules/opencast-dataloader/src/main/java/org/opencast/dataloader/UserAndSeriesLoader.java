...
package org.opencast.dataloader;

import static org.opencast.security.api.DefaultOrganization.DEFAULT_ORGANIZATION_ID;

import org.opencast.kernel.security.OrganizationDirectoryServiceImpl;
...
public class UserAndSeriesLoader {
  ...
  public static final String PROP_DEMO_LOAD_USER = "org.opencast.security.demo.loadusers";
