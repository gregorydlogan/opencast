...
import org.opencast.metadata.dublincore.OpencastDctermsDublinCore;
import org.opencast.metadata.dublincore.OpencastDctermsDublinCore.Series;
...
public class EventsLoader {
  ...
  protected void activate(ComponentContext cc) throws Exception {
    boolean loadTestData = BooleanUtils
            .toBoolean(cc.getBundleContext().getProperty("org.opencast.dataloader.testdata"));

    String csvPath = StringUtils.trimToNull(cc.getBundleContext().getProperty("org.opencast.dataloader.csv"));
  ...
  private void addSchedulerEntry(EventEntry event, MediaPackage mediaPackage) throws Exception {
    ...
    schedulerService.addEvent(event.getRecordingDate(), endDate, event.getCaptureAgent(),
            ...
            Collections.<String, String> emptyMap(), Opt.<Boolean> none(), Opt.some("org.opencast.dataloader"),
