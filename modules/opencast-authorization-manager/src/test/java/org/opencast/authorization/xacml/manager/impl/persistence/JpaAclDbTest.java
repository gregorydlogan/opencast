...
import static org.opencast.security.api.AccessControlUtil.entries;
import static org.opencast.security.api.AccessControlUtil.entry;
...
public final class JpaAclDbTest {
  ...
  private static final JpaAclDb p = new JpaAclDb(PersistenceUtil.newTestPersistenceEnv("org.opencast.authorization.xacml.manager"));
