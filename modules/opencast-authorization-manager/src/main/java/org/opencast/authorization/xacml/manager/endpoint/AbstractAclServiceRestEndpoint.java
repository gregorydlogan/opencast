...
import static org.opencast.authorization.xacml.manager.endpoint.JsonConv.digestManagedAcl;
import static org.opencast.authorization.xacml.manager.endpoint.JsonConv.fullAccessControlList;
import static org.opencast.authorization.xacml.manager.endpoint.JsonConv.nest;
import static org.opencast.authorization.xacml.manager.impl.Util.getManagedAcl;
import static org.opencast.security.api.AccessControlUtil.acl;
import static org.opencast.util.Jsons.arr;
import static org.opencast.util.Jsons.obj;
import static org.opencast.util.Jsons.p;
import static org.opencast.util.RestUtil.R.badRequest;
import static org.opencast.util.RestUtil.R.conflict;
import static org.opencast.util.RestUtil.R.noContent;
...
import static org.opencast.util.RestUtil.splitCommaSeparatedParam;
import static org.opencast.util.data.Either.left;
import static org.opencast.util.data.Either.right;
import static org.opencast.util.data.Monadics.mlist;
import static org.opencast.util.data.Option.option;
import static org.opencast.util.data.Prelude.unexhaustiveMatch;
import static org.opencast.util.data.Tuple.tuple;
import static org.opencast.util.data.functions.Misc.chuck;
import static org.opencast.util.data.functions.Strings.trimToNone;
import static org.opencast.util.doc.rest.RestParameter.Type.BOOLEAN;
import static org.opencast.util.doc.rest.RestParameter.Type.INTEGER;
...
import org.opencast.authorization.xacml.manager.api.AclServiceNoReferenceException;
...
import org.opencast.authorization.xacml.manager.impl.AclTransitionDbDuplicatedException;
import org.opencast.authorization.xacml.manager.impl.ManagedAclImpl;
import org.opencast.authorization.xacml.manager.impl.Util;
...
import org.opencast.util.data.Either;
import org.opencast.util.data.Function;
import org.opencast.util.data.Function2;
import org.opencast.util.data.Monadics;
import org.opencast.util.data.MultiMap;
import org.opencast.util.data.Option;
import org.opencast.util.data.Predicate;
import org.opencast.util.data.Tuple;
import org.opencast.util.data.functions.Functions;
import org.opencast.util.data.functions.Options;
