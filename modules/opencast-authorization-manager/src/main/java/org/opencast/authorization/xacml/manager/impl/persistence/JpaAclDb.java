...
import static org.opencast.authorization.xacml.manager.impl.persistence.ManagedAclEntity.findByIdAndOrg;
import static org.opencast.util.data.functions.Misc.chuck;
import static org.opencast.util.persistence.PersistenceUtil.equip2;
import static org.opencast.util.persistence.PersistenceUtil.persist;
...
import org.opencast.util.persistence.PersistenceEnv2;
...
/** JPA based impl of an {@link org.opencast.authorization.xacml.manager.impl.AclDb}. */
