...
package org.opencast.composer.api;
...
@XmlType(name = "profile", namespace = "http://composer.opencast.org")
@XmlRootElement(name = "profile", namespace = "http://composer.opencast.org")
public class EncodingProfileImpl implements EncodingProfile {
  ...
  */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getIdentifier()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getName()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getSource()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getOutputType()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getSuffix()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getMimeType()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getApplicableMediaType()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#isApplicableTo(org.opencast.composer.api.EncodingProfile.MediaType)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getExtension(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getExtensions()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#hasExtensions()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncodingProfile#getJobLoad()
   */
  @Override
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "extension", namespace = "http://composer.opencast.org")
