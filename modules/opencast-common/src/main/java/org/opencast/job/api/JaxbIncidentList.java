...
import static org.opencast.util.data.Collections.nullToNil;
...
@XmlType(name = "incidentList", namespace = "http://job.opencast.org")
@XmlRootElement(name = "incidentList", namespace = "http://job.opencast.org")
