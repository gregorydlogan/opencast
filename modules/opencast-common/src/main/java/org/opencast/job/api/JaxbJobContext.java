...
@XmlType(name = "jobcontext", namespace = "http://job.opencast.org")
@XmlRootElement(name = "jobcontext", namespace = "http://job.opencast.org")
public class JaxbJobContext implements JobContext {
  ...
  // * {@inheritDoc}
  // *
  // * @see org.opencast.job.api.JobContext#getParentJobId()
  // */
  ...
  // * {@inheritDoc}
  // *
  // * @see org.opencast.job.api.JobContext#getUserId()
  // */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.job.api.JobContext#getProperties()
   */
