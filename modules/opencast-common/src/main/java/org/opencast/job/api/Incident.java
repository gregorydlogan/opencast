...
public interface Incident {
  enum Severity {
     ...
     * {@link org.opencast.job.api.Job.Status#FAILED} state. That implies that there
   ...
   * e.g. <code>org.opencast.service.1511</code>
   *
   * @return the incident code
   * @see org.opencast.job.api.Job#getJobType()
   */
  String getCode();
