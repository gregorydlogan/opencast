...
public final class JobUtil {
  ...
  /**
   * {@link #waitForJob(org.opencast.serviceregistry.api.ServiceRegistry, org.opencast.util.data.Option, org.opencast.job.api.Job)}
   * as a function.
   */
  ...
  /**
   * {@link #waitForJob(org.opencast.job.api.Job, org.opencast.serviceregistry.api.ServiceRegistry, org.opencast.util.data.Option, org.opencast.job.api.Job)}
   * as a function.
   */
  ...
  /** Get all jobs that are not in state {@link org.opencast.job.api.Job.Status#FINISHED}. */
