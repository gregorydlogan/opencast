...
/**
 * Definition of a contract for the use of a {@link org.opencast.util.persistence.PersistenceEnv} in an OSGi environment.
 * <p>
 * Use in conjunction with {@link org.opencast.util.persistence.PersistenceEnvBuilder}.
 */
public interface OsgiPersistenceEnvUser {
   ...
   * </pre>
   * Or better use the {@link org.opencast.util.persistence.PersistenceEnvBuilder}.
   */
  PersistenceEnv getPenv();

  /** Close the persistence environment {@link org.opencast.util.persistence.PersistenceEnv#close()}. Call from the deactivate method. */
  void closePenv();
}
