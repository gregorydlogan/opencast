...
public final class PersistenceEnvBuilder {
  ...
  private Lazy<org.opencast.util.persistencefn.PersistenceEnv> penv = Lazy.lazy(new Function0<org.opencast.util.persistencefn.PersistenceEnv>() {
    @Override public org.opencast.util.persistencefn.PersistenceEnv apply() {
