...
public interface AuthorizationService {
   ...
   * <ol>
   * <li>If exactly zero {@link org.opencast.mediapackage.MediaPackageElements#XACML_POLICY_EPISODE} and
   * {@link org.opencast.mediapackage.MediaPackageElements#XACML_POLICY_SERIES} attachments are present, the
   * returned ACL will be empty.</li>
   * <li>If exactly one {@link org.opencast.mediapackage.MediaPackageElements#XACML_POLICY_EPISODE} is attached
   * to the media package, this is the source of authority</li>
   * <li>If exactly one {@link org.opencast.mediapackage.MediaPackageElements#XACML_POLICY_SERIES} is attached to
   ...
   * {@link org.opencast.mediapackage.MediaPackageElement#getReference()} returns null), that attachment is
   ...
   * {@link org.opencast.mediapackage.MediaPackageElement#getReference()} returns null), the returned ACL will be
   ...
   * {@link org.opencast.mediapackage.MediaPackageElement#getReference()} returns a non-null reference), the
