...
public final class JaxbRole implements Role {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.Role#getName()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.Role#getDescription()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.Role#getOrganization()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.Role#getType()
   */
  public Type getType() {
    return type;
  }
