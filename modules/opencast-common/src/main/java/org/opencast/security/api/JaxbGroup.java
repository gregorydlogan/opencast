...
public final class JaxbGroup implements Group {
  ...
  /**
   * @see org.opencast.security.api.Group#getGroupId()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Group#getName()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Group#getOrganization()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Group#getDescription()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Group#getRole()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Group#getMembers()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Group#getRoles()
   */
  @Override
