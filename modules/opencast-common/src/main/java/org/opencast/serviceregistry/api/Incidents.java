...
public final class Incidents {
   ...
   * the programmer.
   *
   * @see #record(org.opencast.job.api.Job, org.opencast.job.api.Incident.Severity, int, java.util.Map,
   *      java.util.List)
   * @see org.opencast.job.api.Incident
   */
   ...
   * of severity {@link org.opencast.job.api.Incident.Severity#FAILURE} has already been recorded by the job or
