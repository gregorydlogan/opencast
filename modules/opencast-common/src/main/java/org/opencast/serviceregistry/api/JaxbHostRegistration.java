...
public class JaxbHostRegistration implements HostRegistration {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#getBaseUrl()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#setBaseUrl(String)
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.serviceregistry.api.HostRegistration#getIpAddress()
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.serviceregistry.api.HostRegistration#setIpAddress(String)
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.serviceregistry.api.HostRegistration#getMemory()
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.serviceregistry.api.HostRegistration#setMemory(long)
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.serviceregistry.api.HostRegistration#getCores()
   */
  @Override
  public int getCores() {
    return cores;
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.serviceregistry.api.HostRegistration#setCores(int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#getMaxLoad()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#isActive()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#setActive(boolean)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#isOnline()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#setOnline(boolean)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#isMaintenanceMode()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.HostRegistration#setMaintenanceMode(boolean)
   */
  @Override
