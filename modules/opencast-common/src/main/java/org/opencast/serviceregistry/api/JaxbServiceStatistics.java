...
public class JaxbServiceStatistics implements ServiceStatistics {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.ServiceStatistics#getMeanQueueTime()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.ServiceStatistics#getMeanRunTime()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.ServiceStatistics#getFinishedJobs()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.ServiceStatistics#getQueuedJobs()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.ServiceStatistics#getRunningJobs()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.serviceregistry.api.ServiceStatistics#getServiceRegistration()
   */
  @Override
