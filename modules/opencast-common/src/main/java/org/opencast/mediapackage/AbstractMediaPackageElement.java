...
public abstract class AbstractMediaPackageElement implements MediaPackageElement, Serializable {
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setIdentifier(String)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getIdentifier()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#addTag(java.lang.String)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#removeTag(java.lang.String)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#containsTag(java.lang.String)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#containsTag(java.util.Collection)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getTags()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#clearTags()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getMediaPackage()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getElementType()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getElementDescription()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setElementDescription(String)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getReference()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setReference(MediaPackageReference)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getURI()
   */
  @Override
  public URI getURI() {
    return uri;
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setURI(java.net.URI)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getChecksum()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setChecksum(org.opencast.util.Checksum)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getMimeType()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setMimeType(org.opencast.util.MimeType)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setFlavor(MediaPackageElementFlavor)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getFlavor()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#getSize()
   */
  @Override
  public long getSize() {
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#setSize(long)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#referTo(org.opencast.mediapackage.MediaPackage)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#referTo(org.opencast.mediapackage.MediaPackageElement)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#referTo(org.opencast.mediapackage.MediaPackageReference)
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#clearReference()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageElement#verify()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.ManifestContributor#toManifest(org.w3c.dom.Document,
