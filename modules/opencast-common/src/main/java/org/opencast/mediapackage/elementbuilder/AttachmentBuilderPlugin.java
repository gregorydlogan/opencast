...
public class AttachmentBuilderPlugin extends AbstractAttachmentBuilderPlugin implements MediaPackageElementBuilder {
  ...
  /**
   * @see org.opencast.mediapackage.elementbuilder.AbstractAttachmentBuilderPlugin#accept(URI,
  ...
  /**
   * @see org.opencast.mediapackage.elementbuilder.AbstractAttachmentBuilderPlugin#accept(org.w3c.dom.Node)
   */
  @Override
   ...
   *
   * @see org.opencast.mediapackage.elementbuilder.AbstractElementBuilderPlugin#getPriority()
   */
  @Override
