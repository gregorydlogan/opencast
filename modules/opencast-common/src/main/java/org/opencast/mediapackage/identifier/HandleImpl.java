...
public final class HandleImpl extends IdImpl implements Handle {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.identifier.Handle#getLocalName()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.identifier.Handle#getNamingAuthority()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.identifier.Handle#getFullName()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.identifier.Handle#resolve()
   */
  ...
  /**
   * @see org.opencast.mediapackage.identifier.Handle#update(java.net.URL)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.identifier.Id#compact()
   */
