...
public class MediaPackageBuilderImpl implements MediaPackageBuilder {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.MediaPackageBuilder#createNew()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.MediaPackageBuilder#createNew(org.opencast.mediapackage.identifier.Id)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.MediaPackageBuilder#loadFromXml(java.io.InputStream)
   */
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageBuilder#getSerializer()
   */
  ...
  /**
   * @see org.opencast.mediapackage.MediaPackageBuilder#setSerializer(org.opencast.mediapackage.MediaPackageSerializer)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.MediaPackageBuilder#loadFromXml(java.lang.String)
   */
  @Override
