...
package org.opencast.mediapackage.identifier;
...
public class HandleBuilderImpl implements HandleBuilder {
  ...
  /**
   * @see org.opencast.mediapackage.identifier.HandleBuilder#createNew()
   */
  ...
  /**
   * @see org.opencast.mediapackage.identifier.HandleBuilder#createNew(java.net.URL)
   */
  ...
  /**
   * @see org.opencast.mediapackage.identifier.HandleBuilder#fromString(java.lang.String)
   */
   ...
   *
   * @see org.opencast.mediapackage.identifier.HandleBuilder#resolve(org.opencast.mediapackage.identifier.Handle)
   */
   ...
   *
   * @see org.opencast.mediapackage.identifier.HandleBuilder#update(org.opencast.mediapackage.identifier.Handle,
   *      java.net.URL)
   */
   ...
   *
   * @see org.opencast.mediapackage.identifier.HandleBuilder#delete(org.opencast.mediapackage.identifier.Handle)
   */
