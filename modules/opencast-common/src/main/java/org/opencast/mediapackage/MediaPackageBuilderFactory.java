 ...
 * <code>org.opencast.mediapackage.builder</code>.
 * </p>
 */
public final class MediaPackageBuilderFactory {

  /** Class name for the default media package builder */
  private static final String BUILDER_CLASS = "org.opencast.mediapackage.MediaPackageBuilderImpl";

  /** Name of the system property */
  public static final String PROPERTY_NAME = "org.opencast.mediapackage.builder";
   ...
   * interface to use:
   * <ul>
   * <li>Implementation specified using the <code>org.opencast.mediapackage.builder</code> system property</li>
