...
import org.opencast.mediapackage.MediaPackageElementSelector;
...
public abstract class AbstractMediaPackageElementSelector<T extends MediaPackageElement> implements
   ...
   *
   * @see org.opencast.mediapackage.MediaPackageElementSelector#select(org.opencast.mediapackage.MediaPackage,
   *      boolean)
   */
  @Override
