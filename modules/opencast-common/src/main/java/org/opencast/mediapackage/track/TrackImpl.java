...
import org.opencast.mediapackage.AbstractMediaPackageElement;
...
public class TrackImpl extends AbstractMediaPackageElement implements Track {
  ...
  /**
   * @see org.opencast.mediapackage.Track#getDuration()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.Track#hasAudio()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.Track#hasVideo()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.AbstractMediaPackageElement#toManifest(org.w3c.dom.Document,
   ...
   *
   * @see org.opencast.mediapackage.Track#getDescription()
   */
  @Override
