...
import static org.opencast.util.data.functions.Booleans.not;
import static org.opencast.util.data.functions.Options.sequenceOpt;
import static org.opencast.util.data.functions.Options.toOption;
...
public final class MediaPackageSupport {
   ...
   * membership (see {@link org.opencast.mediapackage.AbstractMediaPackageElement#clone()})
   */
