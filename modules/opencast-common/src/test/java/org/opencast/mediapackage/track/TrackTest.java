...
package org.opencast.mediapackage.track;
...
import org.opencast.mediapackage.elementbuilder.TrackBuilderPlugin;
...
public class TrackTest {
  ...
  public void setUp() throws Exception {
    httpUrl = new URI("http://downloads.opencast.org/media/movie.m4v");
    rtmpUrl = new URI("rtmp://downloads.opencast.org/media/movie.m4v");
    track = TrackImpl.fromURI(httpUrl);
  }

  /**
   * Test method for {@link org.opencast.mediapackage.track.TrackImpl#fromURI(URI)}.
   */
  @Test
  ...
  /**
   * Test method for {@link org.opencast.mediapackage.track.TrackImpl#setDuration(long)}.
   */
  @Test
  ...
  /**
   * Test method for {@link org.opencast.mediapackage.track.TrackImpl#getDuration()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link PresenterTrackBuilderPlugin#accept(URI, org.opencast.mediapackage.MediaPackageElement.Type, org.opencast.mediapackage.MediaPackageElementFlavor)}
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Test method for {@link org.opencast.mediapackage.track.TrackImpl#getStreams()}.
   */
  @Test
  @Ignore
  ...
  /**
   * Test method for
   * {@link org.opencast.mediapackage.track.TrackImpl#addStream(org.opencast.mediapackage.track.AbstractStreamImpl)}
   * .
   */
  @Test
  @Ignore
  ...
  /**
   * Test method for {@link org.opencast.mediapackage.track.TrackImpl#getDescription()}.
   */
  @Test
  @Ignore
  ...
  public void testFlavorMarshalling() throws Exception {
    ...
    JAXBContext context = JAXBContext.newInstance(
            "org.opencast.mediapackage:org.opencast.mediapackage.track",
    ...
    String xml = "<oc:track xmlns:oc=\"http://mediapackage.opencast.org\" type=\"presentation/source\"><oc:tags/><oc:url>http://downloads.opencast.org/media/movie.m4v</oc:url><oc:duration>-1</oc:duration></oc:track>";
    ...
    try {
      ...
      Assert.assertEquals("http://downloads.opencast.org/media/movie.m4v", t2.getURI().toString());
    } finally {
      IoSupport.closeQuietly(inputStream);
    }
    ...
    Assert.assertEquals("http://downloads.opencast.org/media/movie.m4v", t3.getURI().toURL().toExternalForm());
  }
}
