...
import static org.opencast.util.JsonVal.asBoolean;
import static org.opencast.util.JsonVal.asInteger;
...
public class JsonObjTest {
  ...
  @Before
  public void setUp() {
    jsonString = loadFileFromClassPathAsString("/org/opencast/util/obj-test.json").get();
  }
