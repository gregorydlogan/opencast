...
package org.opencast.util.data;
...
import static org.opencast.util.data.Arrays.append;
import static org.opencast.util.data.Arrays.array;
import static org.opencast.util.data.Collections.appendTo;
import static org.opencast.util.data.Collections.concat;
import static org.opencast.util.data.Collections.filter;
import static org.opencast.util.data.Collections.flatMap;
import static org.opencast.util.data.Collections.foldl;
import static org.opencast.util.data.Collections.head;
import static org.opencast.util.data.Collections.iterator;
import static org.opencast.util.data.Collections.join;
import static org.opencast.util.data.Collections.list;
import static org.opencast.util.data.Collections.map;
import static org.opencast.util.data.Collections.repeat;
import static org.opencast.util.data.Collections.toArray;
import static org.opencast.util.data.Collections.toList;
