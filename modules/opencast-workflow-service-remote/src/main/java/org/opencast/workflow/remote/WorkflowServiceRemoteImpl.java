...
package org.opencast.workflow.remote;
...
import org.opencast.util.SolrUtils;
...
import org.opencast.workflow.api.WorkflowQuery.QueryTerm;
...
public class WorkflowServiceRemoteImpl extends RemoteBase implements WorkflowService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#getWorkflowDefinitionById(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService
   *      #getWorkflowInstances(org.opencast.workflow.api.WorkflowQuery)
   */
  @Override
   ...
   *      org.opencast.mediapackage.MediaPackage, java.util.Map)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#resume(long, java.util.Map)
   */
  @Override
