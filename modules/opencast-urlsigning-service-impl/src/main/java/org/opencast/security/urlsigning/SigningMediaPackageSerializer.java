 ...
 *
 */
package org.opencast.security.urlsigning;
...
public class SigningMediaPackageSerializer implements MediaPackageSerializer, ManagedService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.MediaPackageSerializer#encodeURI(URI)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.mediapackage.MediaPackageSerializer#decodeURI(URI)
   */
  @Override
