...
package org.opencast.workflow.handler.ingest;
...
public class IngestWorkflowOperationHandler extends ResumableWorkflowOperationHandlerBase {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.handler.workflow.ResumableWorkflowOperationHandlerBase#activate(org.osgi.service.component.ComponentContext)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.handler.workflow.ResumableWorkflowOperationHandlerBase#start(org.opencast.workflow.api.WorkflowInstance, JobContext)
   */
  @Override
