...
package org.opencast.ingest.scanner;

import static org.opencast.security.util.SecurityUtil.getUserAndOrganization;
...
public class InboxScannerService implements ArtifactInstaller, ManagedService {
  ...
  public synchronized void updated(Dictionary properties) throws ConfigurationException {
    ...
    final int maxthreads = option(cc.getBundleContext().getProperty("org.opencast.inbox.threads")).bind(
