...
package org.opencast.ingest.impl.jmx;
...
public class IngestStatistics implements IngestStatisticsMXBean {
  ...
  /**
   * @see org.opencast.ingest.impl.jmx.IngestStatisticsMXBean#getSuccessfulIngestOperations()
   */
  @Override
  ...
  /**
   * @see org.opencast.ingest.impl.jmx.IngestStatisticsMXBean#getFailedIngestOperations()
   */
  @Override
  ...
  /**
   * @see org.opencast.ingest.impl.jmx.IngestStatisticsMXBean#getTotalBytes()
   */
  @Override
  ...
  /**
   * @see org.opencast.ingest.impl.jmx.IngestStatisticsMXBean#getBytesInLastMinute()
   */
  @Override
  ...
  /**
   * @see org.opencast.ingest.impl.jmx.IngestStatisticsMXBean#getBytesInLastFiveMinutes()
   */
  @Override
  ...
  /**
   * @see org.opencast.ingest.impl.jmx.IngestStatisticsMXBean#getBytesInLastFifteenMinutes()
   */
  @Override
