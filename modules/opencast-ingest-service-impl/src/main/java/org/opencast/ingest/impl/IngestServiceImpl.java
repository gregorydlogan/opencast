...
package org.opencast.ingest.impl;

import static org.apache.commons.lang3.StringUtils.isBlank;
import static org.apache.commons.lang3.exception.ExceptionUtils.getStackTrace;
import static org.opencast.util.JobUtil.waitForJob;
...
import org.opencast.ingest.impl.jmx.IngestStatistics;
import org.opencast.inspection.api.MediaInspectionService;
import org.opencast.job.api.AbstractJobProducer;
...
import org.opencast.mediapackage.identifier.HandleException;
...
import org.opencast.smil.api.util.SmilUtil;
...
import org.opencast.util.ProgressInputStream;
...
import org.opencast.workingfilerepository.api.WorkingFileRepository;
...
public class IngestServiceImpl extends AbstractJobProducer implements IngestService, ManagedService {
  ...
  protected static final String WORKFLOW_DEFINITION_DEFAULT = "org.opencast.workflow.default.definition";

  /** The workflow configuration property prefix **/
  protected static final String WORKFLOW_CONFIGURATION_PREFIX = "org.opencast.workflow.config.";

  /** The key for the legacy mediapackage identifier */
  public static final String LEGACY_MEDIAPACKAGE_ID_KEY = "org.opencast.ingest.legacy.mediapackage.id";

  public static final String JOB_TYPE = "org.opencast.ingest";

  /** Managed Property key to overwrite existing series */
  public static final String PROPKEY_OVERWRITE_SERIES = "org.opencast.series.overwrite";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addZippedMediaPackage(java.io.InputStream)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addZippedMediaPackage(java.io.InputStream, java.lang.String)
   */
  @Override
  ...
  private MediaPackage loadMediaPackageFromManifest(InputStream manifest) throws IOException, MediaPackageException,
    ...
    try {
      ...
      String mpNSUri = "http://mediapackage.opencast.org";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#createMediaPackage()
   */
  @Override
  public MediaPackage createMediaPackage() throws MediaPackageException,
          org.opencast.util.ConfigurationException, HandleException {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addTrack(java.net.URI,
   *      org.opencast.mediapackage.MediaPackageElementFlavor, org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   *
   * @see org.opencast.ingest.api.IngestService#addTrack(java.net.URI,
   *      org.opencast.mediapackage.MediaPackageElementFlavor, String[] , org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addTrack(java.io.InputStream, java.lang.String,
   *      org.opencast.mediapackage.MediaPackageElementFlavor, org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addCatalog(java.net.URI,
   *      org.opencast.mediapackage.MediaPackageElementFlavor, org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addCatalog(java.io.InputStream, java.lang.String,
   *      org.opencast.mediapackage.MediaPackageElementFlavor, org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addAttachment(java.net.URI,
   *      org.opencast.mediapackage.MediaPackageElementFlavor, org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#addAttachment(java.io.InputStream, java.lang.String,
   *      org.opencast.mediapackage.MediaPackageElementFlavor, org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#ingest(org.opencast.mediapackage.MediaPackage)
   */
  @Override
  ...
  public void schedule(MediaPackage mediaPackage, String workflowDefinitionID, Map<String, String> properties)
    ...
    for (String key: properties.keySet()) {
      if (key.startsWith("org.opencast.workflow.config.")) {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.ingest.api.IngestService#discardMediaPackage(org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.job.api.AbstractJobProducer#getServiceRegistry()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.job.api.AbstractJobProducer#getSecurityService()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.job.api.AbstractJobProducer#getUserDirectoryService()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.job.api.AbstractJobProducer#getOrganizationDirectoryService()
   */
  @Override
