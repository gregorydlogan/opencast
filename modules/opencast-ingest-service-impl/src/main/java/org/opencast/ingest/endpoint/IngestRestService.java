...
import org.opencast.util.UploadJob;
import org.opencast.util.UploadProgressListener;
import org.opencast.util.data.Function0.X;
...
public class IngestRestService extends AbstractJobProducerEndpoint {
  ...
  protected static final String DEFAULT_WORKFLOW_DEFINITION = "org.opencast.workflow.default.definition";

  /** Key for the default maximum number of ingests in config.properties */
  protected static final String MAX_INGESTS_KEY = "org.opencast.ingest.max.concurrent";
