...
package org.opencast.workflow.handler.notification;

import org.opencast.email.template.api.EmailTemplateService;
...
public class EmailWorkflowOperationHandler extends AbstractWorkflowOperationHandler {
   ...
   * (non-Javadoc)
   *
   * @see org.opencast.workflow.api.AbstractWorkflowOperationHandler#activate
