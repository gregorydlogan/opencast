...
public class BaseEndpointTest {
  ...
  public void testGetOrganizationProperties() throws Exception {
    ...
    JSONObject json = (JSONObject) parser.parse(response);
    assertEquals("https://feeds.opencast.org", json.get("org.opencast.feed.url"));
    assertEquals("https://documentation.opencast.org", json.get("org.opencast.admin.documentation.url"));
    assertEquals("https://api.opencast.org", json.get("org.opencast.external.api.url"));
  }
