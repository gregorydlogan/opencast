...
import org.opencast.rest.StaticResource;
...
public class ResumableWorkflowOperationHandlerBase extends AbstractWorkflowOperationHandler implements
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.AbstractWorkflowOperationHandler#activate(org.osgi.service.component.ComponentContext)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.ResumableWorkflowOperationHandler#getHoldStateUserInterfaceURL(org.opencast.workflow.api.WorkflowInstance)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.ResumableWorkflowOperationHandler#getHoldActionTitle()
   */
