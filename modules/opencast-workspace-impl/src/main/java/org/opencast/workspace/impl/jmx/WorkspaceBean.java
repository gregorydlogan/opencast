...
package org.opencast.workspace.impl.jmx;
...
public class WorkspaceBean implements WorkspaceMXBean {
  ...
  /**
   * @see org.opencast.workspace.impl.jmx.WorkspaceMXBean#getFreeSpace()
   */
  @Override
  ...
  /**
   * @see org.opencast.workspace.impl.jmx.WorkspaceMXBean#getUsedSpace()
   */
  @Override
  ...
  /**
   * @see org.opencast.workspace.impl.jmx.WorkspaceMXBean#getTotalSpace()
   */
  @Override
