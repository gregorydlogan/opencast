...
package org.opencast.message.broker.api.index;
...
public abstract class AbstractIndexProducer implements IndexProducer {
   ...
   *         {@link org.opencast.message.broker.api.index.AbstractIndexProducer.IndexRecreationBatch#update(Organization, P1[])}
   *         method be called
   * @param endMessageOrg
