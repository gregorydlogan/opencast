...
import static org.opencast.assetmanager.api.fn.Properties.getStringOpt;
import static org.opencast.scheduler.api.SchedulerService.ReviewStatus.UNSENT;
import static org.opencast.scheduler.impl.SchedulerUtil.calculateChecksum;
import static org.opencast.scheduler.impl.SchedulerUtil.episodeToMp;
import static org.opencast.scheduler.impl.SchedulerUtil.eventOrganizationFilter;
import static org.opencast.scheduler.impl.SchedulerUtil.filterByNamespace;
import static org.opencast.scheduler.impl.SchedulerUtil.isNotEpisodeDublinCore;
import static org.opencast.scheduler.impl.SchedulerUtil.recordToMp;
import static org.opencast.scheduler.impl.SchedulerUtil.toKey;
import static org.opencast.scheduler.impl.SchedulerUtil.toReviewStatus;
import static org.opencast.scheduler.impl.SchedulerUtil.toValue;
import static org.opencast.scheduler.impl.SchedulerUtil.uiAdapterToFlavor;
import static org.opencast.util.EqualsUtil.ne;
import static org.opencast.util.Log.getHumanReadableTimeString;
...
import org.opencast.assetmanager.api.PropertyId;
import org.opencast.assetmanager.api.PropertyName;
import org.opencast.assetmanager.api.Snapshot;
import org.opencast.assetmanager.api.Value;
import org.opencast.assetmanager.api.Version;
import org.opencast.assetmanager.api.fn.ARecords;
import org.opencast.assetmanager.api.fn.Properties;
...
import org.opencast.assetmanager.api.query.PropertyField;
import org.opencast.assetmanager.api.query.PropertySchema;
...
import org.opencast.message.broker.api.scheduler.SchedulerItem;
...
public class SchedulerServiceImpl extends AbstractIndexProducer implements SchedulerService, ManagedService {
  ...
  public static final String WORKFLOW_CONFIG_PREFIX = "org.opencast.workflow.config.";
