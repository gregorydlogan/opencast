...
package org.opencast.scheduler.endpoint;
...
import static org.opencast.capture.CaptureParameters.AGENT_REGISTRATION_TYPE;
import static org.opencast.capture.CaptureParameters.AGENT_REGISTRATION_TYPE_ADHOC;
...
import static org.opencast.util.Jsons.v;
import static org.opencast.util.RestUtil.generateErrorResponse;
import static org.opencast.util.data.Monadics.mlist;

import org.opencast.capture.admin.api.Agent;
import org.opencast.capture.admin.api.AgentState;
...
import org.opencast.scheduler.impl.CaptureNowProlongingService;
...
import org.opencast.util.Jsons.Arr;
import org.opencast.util.Jsons.Prop;
...
import org.opencast.util.doc.rest.RestParameter.Type;
...
public class SchedulerRestService {
  ...
  private static final String DEFAULT_WORKFLOW_DEFINITION = "org.opencast.workflow.default.definition";
  ...
  @RestQuery(name = "newrecordings", description = "Creates new event with specified parameters",
          ...
          @RestParameter(name = "wfproperties", isRequired = false, type = Type.TEXT, description = "Workflow "
                  + "configuration keys for the event. Each key will be prefixed by 'org.opencast.workflow"
  ...
  public Response startCapture(@PathParam("agent") String agentId, @FormParam("workflowDefinitionId") String wfId)
    ...
    try {
      ...
      Map<String, String> caProperties = new HashMap<>();
      caProperties.put("org.opencast.workflow.definition", workflowId);
      caProperties.put("event.location", agentId);
      caProperties.put("event.title", "Capture now event");
      // caProperties.put("org.opencast.workflow.config.captionHold", "false");
      // caProperties.put("org.opencast.workflow.config.archiveOp", "true");
      // caProperties.put("org.opencast.workflow.config.trimHold", "false");
