 ...
 *
 */
package org.opencast.distribution.aws.s3;
...
import org.opencast.distribution.aws.s3.api.AwsS3DistributionService;
...
public class AwsS3DistributionServiceImpl extends AbstractDistributionService implements AwsS3DistributionService,
  ...
  /** Job type */
  public static final String JOB_TYPE = "org.opencast.distribution.aws.s3";
  ...
  public static final String AWS_S3_DISTRIBUTION_ENABLE = "org.opencast.distribution.aws.s3.distribution.enable";
  public static final String AWS_S3_DISTRIBUTION_BASE_CONFIG = "org.opencast.distribution.aws.s3.distribution.base";
  public static final String AWS_S3_ACCESS_KEY_ID_CONFIG = "org.opencast.distribution.aws.s3.access.id";
  public static final String AWS_S3_SECRET_ACCESS_KEY_CONFIG = "org.opencast.distribution.aws.s3.secret.key";
  public static final String AWS_S3_REGION_CONFIG = "org.opencast.distribution.aws.s3.region";
  public static final String AWS_S3_BUCKET_CONFIG = "org.opencast.distribution.aws.s3.bucket";
  // config.properties
  public static final String OPENCAST_DOWNLOAD_URL = "org.opencast.download.url";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.distribution.api.DownloadDistributionService#distribute(String,
   *      org.opencast.mediapackage.MediaPackage, String, boolean)
   */
  @Override
   ...
   * @return the retracted element or <code>null</code> if the element was not retracted
   * @throws org.opencast.distribution.api.DistributionException
   *           in case of an error
   */
