...
import org.opencast.index.service.impl.index.theme.ThemeSearchQuery;
...
import org.opencast.messages.MailServiceException;
...
import org.opencast.staticfiles.api.StaticFileService;
import org.opencast.staticfiles.endpoint.StaticFileRestService;
import org.opencast.themes.Theme;
import org.opencast.themes.persistence.ThemesServiceDatabaseException;
...
public class TestThemesEndpoint extends ThemesEndpoint {
  ...
  private void setupServices() throws Exception {
    ...
    EasyMock.expect(adminUISearchIndex.getByQuery(EasyMock.capture(themeQueryCapture)))
            .andAnswer(new IAnswer<SearchResult<org.opencast.index.service.impl.index.theme.Theme>>() {

              @Override
              public SearchResult<org.opencast.index.service.impl.index.theme.Theme> answer() throws Throwable {
    ...
    EasyMock.expect(bundleContext.getProperty("org.opencast.server.url")).andReturn("http://localhost:8080")
            .anyTimes();
  ...
  private SearchResult<org.opencast.index.service.impl.index.theme.Theme> createThemeCaptureResult(
          final Capture<ThemeSearchQuery> myCapture) {
    SearchResultImpl<org.opencast.index.service.impl.index.theme.Theme> searchResults = new SearchResultImpl<org.opencast.index.service.impl.index.theme.Theme>(
    ...
    if (myCapture.hasCaptured()) {
      if (myCapture.getValue().getIdentifiers().length == 1 && myCapture.getValue().getIdentifiers()[0] == theme1Id) {
        SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> searchResultItem = getThemeSearchResultItem(
                theme1Id, "theme-1-name");
        searchResults.addResultItem(searchResultItem);
      } else if (myCapture.getValue().getIdentifiers().length == 0) {
        SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> searchResultItem1 = getThemeSearchResultItem(
                theme1Id, "theme-1-name");
        searchResults.addResultItem(searchResultItem1);
        SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> searchResultItem2 = getThemeSearchResultItem(
                theme2Id, "theme-2-name");
        searchResults.addResultItem(searchResultItem2);
        SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> searchResultItem3 = getThemeSearchResultItem(
  ...
  private SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> getThemeSearchResultItem(Long id,
          String name) {
    org.opencast.index.service.impl.index.theme.Theme theme = new org.opencast.index.service.impl.index.theme.Theme(
            id, defaultOrg.getId());
    ...
    SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> searchResultItem = EasyMock
