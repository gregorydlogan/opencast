...
import org.opencast.index.service.impl.IndexServiceImpl;
...
import org.opencast.index.service.resources.list.provider.UsersListProvider;
import org.opencast.matterhorn.search.SearchIndexException;
import org.opencast.matterhorn.search.SearchQuery.Order;
...
import org.opencast.metadata.dublincore.DublinCoreXmlFormat;
...
public class TestSeriesEndpoint extends SeriesEndpoint {
  ...
  private void setupIndex() throws SearchIndexException, IOException, IllegalStateException, ParseException {
    ...
    org.opencast.index.service.impl.index.theme.Theme theme1 = new org.opencast.index.service.impl.index.theme.Theme(
    ...
    final SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> themeItem1 = EasyMock
    ...
    EasyMock.expect(adminuiSearchIndex.getByQuery(EasyMock.capture(captureThemeSearchQuery)))
            .andAnswer(new IAnswer<SearchResult<org.opencast.index.service.impl.index.theme.Theme>>() {
              ...
              public SearchResult<org.opencast.index.service.impl.index.theme.Theme> answer() throws Throwable {
                SearchResult<org.opencast.index.service.impl.index.theme.Theme> themeSearchResult = EasyMock
