...
package org.opencast.adminui.impl.index;

import org.opencast.index.service.api.EventIndex;
...
public class AdminUISearchIndex extends AbstractSearchIndex implements EventIndex {
  ...
  /**
   * @see org.opencast.matterhorn.search.impl.AbstractElasticsearchIndex#getDocumenTypes()
   */
  @Override
