...
import static org.opencast.index.service.util.RestUtils.conflictJson;
import static org.opencast.index.service.util.RestUtils.notFound;
import static org.opencast.index.service.util.RestUtils.okJson;
import static org.opencast.index.service.util.RestUtils.okJsonList;
import static org.opencast.util.DateTimeSupport.toUTC;
import static org.opencast.util.RestUtil.R.badRequest;
import static org.opencast.util.RestUtil.R.forbidden;
import static org.opencast.util.RestUtil.R.notFound;
import static org.opencast.util.RestUtil.R.ok;
import static org.opencast.util.RestUtil.R.serverError;
import static org.opencast.util.doc.rest.RestParameter.Type.BOOLEAN;
import static org.opencast.util.doc.rest.RestParameter.Type.STRING;
import static org.opencast.util.doc.rest.RestParameter.Type.TEXT;

import org.opencast.adminui.exception.JobEndpointException;
import org.opencast.adminui.impl.AdminUIConfiguration;
import org.opencast.adminui.impl.index.AdminUISearchIndex;
import org.opencast.adminui.util.QueryPreprocessor;
import org.opencast.authorization.xacml.manager.api.AclService;
import org.opencast.authorization.xacml.manager.api.AclServiceException;
...
import org.opencast.index.service.catalog.adapter.MetadataList.Locked;
...
import org.opencast.index.service.impl.index.event.EventIndexSchema;
import org.opencast.index.service.impl.index.event.EventSearchQuery;
import org.opencast.index.service.impl.index.event.EventUtils;
import org.opencast.index.service.resources.list.provider.EventCommentsListProvider;
import org.opencast.index.service.resources.list.provider.EventsListProvider.Comments;
import org.opencast.index.service.resources.list.query.EventListQuery;
...
import org.opencast.mediapackage.AudioStream;
...
import org.opencast.mediapackage.VideoStream;
import org.opencast.mediapackage.track.AudioStreamImpl;
import org.opencast.mediapackage.track.VideoStreamImpl;
...
import org.opencast.rest.BulkOperationResult;
...
import org.opencast.security.urlsigning.exception.UrlSigningException;
...
import org.opencast.util.Jsons.Val;
...
import org.opencast.workflow.api.WorkflowUtil;
 ...
 * set.
 * <p>
 * This first implementation uses the {@link org.opencast.assetmanager.api.AssetManager}. In a later iteration
...
public abstract class AbstractEventEndpoint {
  ...
  public Response getEventComments(@PathParam("eventId") String eventId) throws Exception {
    ...
    try {
      ...
      return Response.ok(org.opencast.util.Jsons.arr(commentArr).toJson(), MediaType.APPLICATION_JSON_TYPE)
              .build();
  ...
  private List<Field> streamsToJSON(org.opencast.mediapackage.Stream[] streams) {
    List<Field> fields = new ArrayList<>();
    List<JValue> audioList = new ArrayList<>();
    List<JValue> videoList = new ArrayList<>();
    for (org.opencast.mediapackage.Stream stream : streams) {
