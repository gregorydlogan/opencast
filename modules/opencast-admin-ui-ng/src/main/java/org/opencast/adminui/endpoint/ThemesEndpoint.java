...
import org.opencast.index.service.impl.index.theme.ThemeIndexSchema;
import org.opencast.index.service.impl.index.theme.ThemeSearchQuery;
import org.opencast.index.service.resources.list.query.ThemesListQuery;
...
import org.opencast.themes.ThemesServiceDatabase;
...
import org.opencast.util.RestUtil.R;
...
public class ThemesEndpoint {
  ...
  public Response getThemes(@QueryParam("filter") String filter, @QueryParam("limit") int limit,
    ...
    SearchResult<org.opencast.index.service.impl.index.theme.Theme> results = null;
    try {
    ...
    for (SearchResultItem<org.opencast.index.service.impl.index.theme.Theme> item : results.getItems()) {
      org.opencast.index.service.impl.index.theme.Theme theme = item.getSource();
  ...
  public Response getThemeResponse(@PathParam("themeId") long id) throws Exception {
    Opt<org.opencast.index.service.impl.index.theme.Theme> theme = getTheme(id);
    if (theme.isNone())
  ...
  public Response getThemeUsage(@PathParam("themeId") long themeId) throws Exception {
    Opt<org.opencast.index.service.impl.index.theme.Theme> theme = getTheme(themeId);
    if (theme.isNone())
   ...
   */
  private Opt<org.opencast.index.service.impl.index.theme.Theme> getTheme(long id) throws SearchIndexException {
    SearchResult<org.opencast.index.service.impl.index.theme.Theme> result = searchIndex
    ...
    if (result.getPageSize() == 0) {
      ...
      return Opt.<org.opencast.index.service.impl.index.theme.Theme> none();
    }
   ...
   */
  private JValue themeToJSON(org.opencast.index.service.impl.index.theme.Theme theme, boolean editResponse) {
