...
package org.opencast.adminui.api;

import org.opencast.adminui.util.Language;
...
/**
 * A service which provides information about translations for the opencast-admin-ui-ng bundle. Usage: Configure the
...
public interface LanguageService {
  ...
  String TRANSLATION_FILES_PATH = "public/org/opencast/adminui/languages/";
  ...
  /**
   * A list of the locales for which translations of the opencast-admin-ui-ng are available.
   *
