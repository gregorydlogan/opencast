...
import static org.opencast.util.RestUtil.getEndpointUrl;
import static org.opencast.util.UrlSupport.uri;
import static org.opencast.util.doc.rest.RestParameter.Type.STRING;

import org.opencast.adminui.util.TextFilter;
import org.opencast.authorization.xacml.manager.endpoint.JsonConv;
...
import org.opencast.userdirectory.JpaUserAndRoleProvider;
import org.opencast.util.NotFoundException;
import org.opencast.util.RestUtil;
import org.opencast.util.SmartIterator;
