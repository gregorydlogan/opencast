...
public class MediaDurationImpl implements MediaDuration {
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaDuration#getDays()
   */
  public int getDays() {
    return days;
  }
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaDuration#getFractions()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaDuration#getFractionsPerSecond()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaDuration#getHours()
   */
  public int getHours() {
    return hours;
  }
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaDuration#getMinutes()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaDuration#getSeconds()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaDuration#getDurationInMilliseconds()
   */
