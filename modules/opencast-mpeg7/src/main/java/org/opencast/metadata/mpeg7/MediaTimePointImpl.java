...
public class MediaTimePointImpl implements MediaTimePoint {
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint
   */
  public int getDay() {
    return day;
  }
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getHour()
   */
  public int getHour() {
    return hour;
  }
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getMinutes()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getMonth()
   */
  public int getMonth() {
    return month;
  }
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getNFractions()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getSeconds()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getYear()
   */
  public int getYear() {
    return year;
  }
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getFractionsPerSecond()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#getTimeInMilliseconds()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MediaTimePoint#isRelative()
   */
