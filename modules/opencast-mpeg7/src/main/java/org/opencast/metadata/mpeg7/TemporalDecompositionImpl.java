...
public class TemporalDecompositionImpl<T extends Segment> implements TemporalDecomposition<T> {
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#setGap(boolean)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#hasGap()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#hasSegments()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#setOverlapping(boolean)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#setCriteria(org.opencast.metadata.mpeg7.TemporalDecomposition.DecompositionCriteria)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#isOverlapping()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#getCriteria()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#getSegmentById(java.lang.String)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TemporalDecomposition#segments()
   */
