...
public class TextAnnotationImpl implements TextAnnotation {
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TextAnnotation#addKeywordAnnotation(org.opencast.metadata.mpeg7.KeywordAnnotation)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TextAnnotation#addFreeTextAnnotation(org.opencast.metadata.mpeg7.FreeTextAnnotation)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TextAnnotation#getConfidence()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TextAnnotation#getLanguage()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TextAnnotation#getRelevance()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TextAnnotation#keywordAnnotations()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.TextAnnotation#freeTextAnnotations()
   */
