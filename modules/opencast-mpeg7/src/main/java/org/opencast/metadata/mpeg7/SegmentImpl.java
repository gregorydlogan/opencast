...
public class SegmentImpl implements Segment, AudioSegment, VideoSegment, AudioVisualSegment {
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#getIdentifier()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#setMediaTime(org.opencast.metadata.mpeg7.MediaTime)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#getMediaTime()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#hasTextAnnotations()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#hasTextAnnotations(java.lang.String)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#hasTextAnnotations(float, float)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#hasTextAnnotations(float, float, java.lang.String)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#getTextAnnotationCount()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#textAnnotationsByConfidence()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#textAnnotationsByRelevance()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#createTextAnnotation(float, float, String)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.Segment#textAnnotations()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoSegment#createSpatioTemporalDecomposition(boolean, boolean)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.AudioVisualSegment#getSpatioTemporalDecomposition()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.AudioVisualSegment#hasSpatioTemporalDecomposition()
   */
  @Override
  ...
  /**
   * @see org.opencast.mediapackage.XmlElement#toXml(org.w3c.dom.Document)
   */
