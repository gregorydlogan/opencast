...
public class MultimediaContentImpl<T extends MultimediaContentType> implements MultimediaContent<T> {
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContent#elements()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContent#getElementById(java.lang.String)
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContent#getType()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContent#size()
   */
  public int size() {
    return content.size();
  }
  ...
  /**
   * @see org.opencast.mediapackage.XmlElement#toXml(Document)
   */
