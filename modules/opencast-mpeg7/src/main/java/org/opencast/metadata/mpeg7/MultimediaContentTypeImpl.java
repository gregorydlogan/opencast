...
public class MultimediaContentTypeImpl<S extends Segment> implements MultimediaContentType, Audio, Video, AudioVisual {
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContentType#getId()
   */
  public String getId() {
    return id;
  }
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContentType#getMediaLocator()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContentType#getMediaTime()
   */
  ...
  /**
   * @see org.opencast.metadata.mpeg7.MultimediaContentType#getTemporalDecomposition()
   */
