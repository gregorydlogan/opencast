...
public class SpatioTemporalDecompositionImpl implements SpatioTemporalDecomposition {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#hasGap()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#isOverlapping()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#setGap(boolean)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#setOverlapping(boolean)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#addVideoText(org.opencast.metadata.mpeg7.Textual,
   *      java.awt.Rectangle, org.opencast.metadata.mpeg7.MediaTime)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#addVideoText(org.opencast.metadata.mpeg7.VideoText)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#getVideoText()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.SpatioTemporalDecomposition#getVideoText(java.lang.String)
   */
  @Override
