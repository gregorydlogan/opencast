...
public class VideoTextImpl implements VideoText {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#setIdentifier(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#setType(org.opencast.metadata.mpeg7.VideoText.Type)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#getType()
   */
  @Override
  public Type getType() {
    return type;
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#setText(org.opencast.metadata.mpeg7.Textual)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#getText()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#setBoundary(java.awt.Rectangle)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#getBoundary()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#setFontSize(int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#getFontSize()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#setFontType(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.VideoText#getFontType()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.MovingRegion#setSpatioTemporalLocator(org.opencast.metadata.mpeg7.SpatioTemporalLocator)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.metadata.mpeg7.MovingRegion#getSpatioTemporalLocator()
   */
  @Override
