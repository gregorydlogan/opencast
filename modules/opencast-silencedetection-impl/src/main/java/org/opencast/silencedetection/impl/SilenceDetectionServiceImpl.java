...
package org.opencast.silencedetection.impl;
...
import org.opencast.silencedetection.api.MediaSegment;
import org.opencast.silencedetection.api.MediaSegments;
import org.opencast.silencedetection.api.SilenceDetectionFailedException;
import org.opencast.silencedetection.api.SilenceDetectionService;
import org.opencast.silencedetection.ffmpeg.FFmpegSilenceDetector;
...
public class SilenceDetectionServiceImpl extends AbstractJobProducer implements SilenceDetectionService, ManagedService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.silencedetection.api.SilenceDetectionService#detect(
   * org.opencast.mediapackage.Track)
   */
  @Override
   ...
   *
   * @see org.opencast.silencedetection.api.SilenceDetectionService#detect(
   * org.opencast.mediapackage.Track, org.opencast.mediapackage.Track[])
   */
  @Override
   ...
   * {@link org.opencast.silencedetection.api.MediaSegments}
   * XML as string. Source track should have an audio stream. All detected
   * {@link org.opencast.silencedetection.api.MediaSegment}s
