 ...
 */
@XmlType(name = "recording-state-update", namespace = "http://capture.admin.opencast.org")
@XmlRootElement(name = "recording-state-update", namespace = "http://capture.admin.opencast.org")
...
public class RecordingStateUpdate {
  ...
  /**
   * The state of the recording. This should be defined from {@link org.opencast.scheduler.api.RecordingState}.
   *
   * @see org.opencast.scheduler.api.RecordingState
   */
