...
public interface ExecuteService {
  ...
  /** Receipt type */
  String JOB_TYPE = "org.opencast.execute";
   ...
   * @param inElement
   *          An {@link org.opencast.mediapackage.MediaPackageElement} object to be used as an input to the
   *          command
   * @return A {@link org.opencast.job.api.Job} representing the execution of the command. After a successful
   ...
   * {@link org.opencast.mediapackage.MediaPackageElement} will be created with the
   * {@link org.opencast.mediapackage.MediaPackageElement.Type} indicated by the argument {@code type}.
   * 
   * @param exec
   *          The command to be executed by this method
   * @param args
   ...
   * @param type
   *          The {@link org.opencast.mediapackage.MediaPackageElement.Type} of the {@code MediaPackageElement}
   ...
   * accepts a {@link org.opencast.mediapackage.MediaPackage} as an argument, and elements within that
   ...
   * @param mp
   *          The {@link org.opencast.mediapackage.MediaPackage} containing {@code MediaPackageElements} that
