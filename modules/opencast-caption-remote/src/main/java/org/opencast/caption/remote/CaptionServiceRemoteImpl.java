...
package org.opencast.caption.remote;
...
public class CaptionServiceRemoteImpl extends RemoteBase implements CaptionService {
  ...
  /**
   * @see org.opencast.caption.api.CaptionService#convert(MediaPackageElement, String, String)
   */
  @Override
  ...
  /**
   * @see org.opencast.caption.api.CaptionService#convert(MediaPackageElement, String, String, String)
   */
  @Override
  ...
  /**
   * @see org.opencast.caption.api.CaptionService#getLanguageList(MediaPackageElement, String)
   */
  @Override
