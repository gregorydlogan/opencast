...
package org.opencast.publication.youtube;
...
import org.opencast.publication.api.YouTubePublicationService;
import org.opencast.publication.youtube.auth.ClientCredentials;
...
import org.opencast.util.XProperties;
...
public class YouTubeV3PublicationServiceImpl extends AbstractJobProducer implements YouTubePublicationService, ManagedService {
  ...
  public static final String YOUTUBE_ENABLED_KEY = "org.opencast.publication.youtube.enabled";
