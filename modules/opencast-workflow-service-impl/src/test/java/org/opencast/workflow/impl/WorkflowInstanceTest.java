...
public class WorkflowInstanceTest {
  ...
  public void testFlavorMarshalling() throws Exception {
    ...
    String namespaceXml = "<workflow xmlns=\"http://workflow.opencast.org\" xmlns:mp=\"http://mediapackage.opencast.org\"><parent/><mp:mediapackage><mp:media><mp:track type=\"presentation/source\" id=\"track-1\"><mp:url>http://testing</mp:url></mp:track></mp:media></mp:mediapackage></workflow>";
