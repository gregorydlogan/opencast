...
package org.opencast.workflow.impl.jmx;
...
public class WorkflowsStatistics extends NotificationBroadcasterSupport implements WorkflowsStatisticsMXBean {
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getTotal()
   */
  @Override
  public int getTotal() {
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getInstantiated()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getRunning()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getOnHold()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getStopped()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getFinished()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getFailing()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getFailed()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getWorkflowsOnHold()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getAverageWorkflowProcessingTime()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getAverageWorkflowQueueTime()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.impl.jmx.WorkflowsStatisticsMXBean#getAverageWorkflowHoldTime()
   */
  @Override
