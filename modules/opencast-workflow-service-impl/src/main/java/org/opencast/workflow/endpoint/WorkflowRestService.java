...
package org.opencast.workflow.endpoint;
...
import org.opencast.mediapackage.MediaPackageImpl;
...
import org.opencast.util.LocalHashMap;
...
import org.opencast.workflow.api.Configurable;
...
import org.opencast.workflow.api.WorkflowDefinitionSet;
...
import org.opencast.workflow.impl.WorkflowServiceImpl;
...
public class WorkflowRestService extends AbstractJobProducerEndpoint {
  ...
  public String getSampleMediaPackage() {
    ...
    return "<mediapackage xmlns=\"http://mediapackage.opencast.org\" start=\"2007-12-05T13:40:00\" duration=\"1004400000\">\n"
            + "  <media>\n"
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.rest.AbstractJobProducerEndpoint#getService()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.rest.AbstractJobProducerEndpoint#getServiceRegistry()
   */
  @Override
