...
import static org.opencast.util.data.Collections.mkString;
import static org.opencast.workflow.api.WorkflowInstance.WorkflowState.FAILED;
import static org.opencast.workflow.api.WorkflowInstance.WorkflowState.FAILING;
import static org.opencast.workflow.api.WorkflowInstance.WorkflowState.INSTANTIATED;
import static org.opencast.workflow.api.WorkflowInstance.WorkflowState.PAUSED;
import static org.opencast.workflow.api.WorkflowInstance.WorkflowState.RUNNING;
import static org.opencast.workflow.api.WorkflowInstance.WorkflowState.STOPPED;
import static org.opencast.workflow.api.WorkflowInstance.WorkflowState.SUCCEEDED;

import org.opencast.index.IndexProducer;
...
import org.opencast.mediapackage.MediaPackageSupport;
import org.opencast.message.broker.api.MessageReceiver;
import org.opencast.message.broker.api.MessageSender;
import org.opencast.message.broker.api.index.AbstractIndexProducer;
import org.opencast.message.broker.api.index.IndexRecreateObject;
import org.opencast.message.broker.api.index.IndexRecreateObject.Service;
import org.opencast.message.broker.api.workflow.WorkflowItem;
import org.opencast.metadata.api.MediaPackageMetadata;
...
import org.opencast.util.JobUtil;
import org.opencast.util.Log;
import org.opencast.util.MultiResourceLock;
...
import org.opencast.workflow.api.ResumableWorkflowOperationHandler;
...
import org.opencast.workflow.api.WorkflowListener;
import org.opencast.workflow.api.WorkflowOperationDefinition;
...
import org.opencast.workflow.api.WorkflowOperationResultImpl;
import org.opencast.workflow.api.WorkflowParser;
import org.opencast.workflow.api.WorkflowParsingException;
...
import org.opencast.workflow.api.WorkflowStateException;
import org.opencast.workflow.api.WorkflowStatistics;
import org.opencast.workflow.impl.jmx.WorkflowsStatistics;
...
public class WorkflowServiceImpl extends AbstractIndexProducer implements WorkflowService, JobProducer, ManagedService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#addWorkflowListener(org.opencast.workflow.api.WorkflowListener)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#removeWorkflowListener(org.opencast.workflow.api.WorkflowListener)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#listAvailableWorkflowDefinitions()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#registerWorkflowDefinition(org.opencast.workflow.api.WorkflowDefinition)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#unregisterWorkflowDefinition(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#getWorkflowById(long)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#start(org.opencast.workflow.api.WorkflowDefinition,
   *      org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   *
   * @see org.opencast.workflow.api.WorkflowService#start(org.opencast.workflow.api.WorkflowDefinition,
   *      org.opencast.mediapackage.MediaPackage, Long, java.util.Map)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#stop(long)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#remove(long)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#suspend(long)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#resume(long)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#resume(long, Map)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#update(org.opencast.workflow.api.WorkflowInstance)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#countWorkflowInstances()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#countWorkflowInstances(org.opencast.workflow.api.WorkflowInstance.WorkflowState,
   *      java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#getStatistics()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#getWorkflowInstances(org.opencast.workflow.api.WorkflowQuery)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowService#getWorkflowInstancesForAdministrativeRead(org.opencast.workflow.api.WorkflowQuery)
   */
  @Override
   ...
   *
   * @see org.opencast.job.api.AbstractJobProducer#isReadyToAccept(org.opencast.job.api.Job)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.job.api.AbstractJobProducer#acceptJob(org.opencast.job.api.Job)
   */
  @Override
