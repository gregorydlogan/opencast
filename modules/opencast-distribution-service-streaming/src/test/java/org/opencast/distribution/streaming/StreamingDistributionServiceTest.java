...
public class StreamingDistributionServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    EasyMock.expect(bc.getProperty("org.opencast.streaming.url")).andReturn("rtmp://localhost/").anyTimes();
    EasyMock.expect(bc.getProperty("org.opencast.streaming.directory")).andReturn(distributionRoot.getPath())
            .anyTimes();
    EasyMock.replay(bc);
