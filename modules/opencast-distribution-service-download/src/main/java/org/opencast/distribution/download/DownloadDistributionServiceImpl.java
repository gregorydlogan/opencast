 ...
 *
 */
package org.opencast.distribution.download;

import static java.lang.String.format;
import static org.opencast.util.EqualsUtil.ne;
import static org.opencast.util.HttpUtil.waitForResource;
...
public class DownloadDistributionServiceImpl extends AbstractDistributionService
  ...
  /** Receipt type */
  public static final String JOB_TYPE = "org.opencast.distribution.download";
  ...
  public void activate(ComponentContext cc) {
    super.activate(cc);
    serviceUrl = cc.getBundleContext().getProperty("org.opencast.download.url");
    if (serviceUrl == null)
      throw new IllegalStateException("Download url must be set (org.opencast.download.url)");
    logger.info("Download url is {}", serviceUrl);

    String ccDistributionDirectory = cc.getBundleContext().getProperty("org.opencast.download.directory");
    if (ccDistributionDirectory == null)
      throw new IllegalStateException("Distribution directory must be set (org.opencast.download.directory)");
