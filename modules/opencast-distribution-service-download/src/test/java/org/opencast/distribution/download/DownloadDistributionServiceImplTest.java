...
public class DownloadDistributionServiceImplTest {
  ...
  public void setUp() throws Exception {
    ...
    EasyMock.expect(bc.getProperty("org.opencast.download.directory")).andReturn(distributionRoot.toString()).anyTimes();
    EasyMock.expect(bc.getProperty("org.opencast.download.url")).andReturn(UrlSupport.DEFAULT_BASE_URL).anyTimes();
