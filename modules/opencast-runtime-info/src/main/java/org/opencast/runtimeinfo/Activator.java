...
public class Activator extends HttpServlet implements BundleActivator {
  ...
  private void prepareMacros() {
    ...
    globalMacro.put("PING_BACK_URL", bundleContext.getProperty("org.opencast.anonymous.feedback.url"));
    globalMacro.put("HOST_URL", bundleContext.getProperty(MatterhornConstants.SERVER_URL_PROPERTY));
    globalMacro.put("LOCAL_STORAGE_DIRECTORY", bundleContext.getProperty("org.opencast.storage.dir"));
  }
