...
package org.opencast.runtimeinfo;

import static org.opencast.rest.RestConstants.SERVICES_FILTER;
...
import org.opencast.userdirectory.UserIdRoleProvider;
 ...
 *
 * If the 'org.opencast.anonymous.feedback.url' is set in config.properties, this service will also update the
...
public class RuntimeInfo {
  ...
  private static final String ADMIN_URL_PROPERTY = "org.opencast.admin.ui.url";
  ...
  public String getRuntimeInfo(@Context HttpServletRequest request) throws MalformedURLException {
    ...
    if (targetEngageBaseUrl == null) {
      logger.debug(
              "Using 'org.opencast.server.url' as a fallback for the non-existing organization level key '{}' for the components.json response",
              ENGAGE_URL_PROPERTY);
