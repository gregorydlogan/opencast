...
public class AwsArchiveDatabaseImplTest {
  ...
  private AwsArchiveDatabaseImpl database;
  ...
  public void setUp() throws Exception {
    ...
    database = new AwsArchiveDatabaseImpl();
    database.setEntityManagerFactory(PersistenceUtil.newTestEntityManagerFactory(AwsArchiveDatabaseImpl.PERSISTENCE_UNIT));
  ...
  public void testStoreMapping() throws Exception {
    ...
    AwsArchiveMapping mapping = database.findMapping(path);
  ...
  public void testDeleteMapping() throws Exception {
    ...
    List<AwsArchiveMapping> mappings = database.findAllByMediaPackage(MP_ID);
  ...
  public void testFindMappingByKey() throws Exception {
    ...
    List<AwsArchiveMapping> mappings = database.findMappingsByKey("archive_path/" + ASSET1_ID);
    Assert.assertEquals(2, mappings.size());
    AwsArchiveMapping m1 = mappings.get(0);
    AwsArchiveMapping m2 = mappings.get(1);
  ...
  public void testFindMappingByMediaPackageAndVersion() throws Exception {
    ...
    List<AwsArchiveMapping> mappings = database.findMappingsByMediaPackageAndVersion(path);
    Assert.assertEquals(1, mappings.size());
