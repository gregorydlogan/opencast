...
public class AwsGlacierAssetStore extends AwsAbstractArchive implements RemoteAssetStore {
  ...
  public static final String AWS_GLACIER_ACCESS_KEY_ID_CONFIG = "org.opencastproject.assetmanager.aws.glacier.access.id";
  public static final String AWS_GLACIER_SECRET_ACCESS_KEY_CONFIG = "org.opencastproject.assetmanager.aws.glacier.secret.key";
  public static final String AWS_GLACIER_REGION_CONFIG = "org.opencastproject.assetmanager.aws.glacier.region";
  public static final String AWS_GLACIER_VAULT_CONFIG = "org.opencastproject.assetmanager.aws.glacier.vault";
  ...
  public void activate(final ComponentContext cc) throws IllegalStateException, IOException {
    ...
    if (cc != null) {
      ...
      logger.info("AwsGlacierAssetStore activated!");
      createAWSVault();
    }
  ...
  public InputStream getObject(AwsAssetMapping map) throws AssetStoreException {
  ...
  public void deleteObject(AwsAssetMapping map) throws AssetStoreException {
