...
public class AwsS3ArchiveElementStore extends AwsAbstractArchive implements RemoteAssetStore {

  /** Log facility */
  private static final Logger logger = LoggerFactory.getLogger(AwsS3ArchiveElementStore.class);
   ...
   *
   */
  protected InputStream getObject(AwsArchiveMapping map) {
  ...
  *
  */
  protected void deleteObject(AwsArchiveMapping map) {
