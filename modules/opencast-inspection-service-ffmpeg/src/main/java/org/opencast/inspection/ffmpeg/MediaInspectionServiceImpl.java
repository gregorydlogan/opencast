...
import org.opencast.inspection.api.util.Options;
...
public class MediaInspectionServiceImpl extends AbstractJobProducer implements MediaInspectionService, ManagedService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.inspection.api.MediaInspectionService#inspect(java.net.URI)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.inspection.api.MediaInspectionService#inspect(java.net.URI, java.util.Map)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.inspection.api.MediaInspectionService#enrich(org.opencast.mediapackage.MediaPackageElement,
   *      boolean)
   */
  @Override
