...
package org.opencast.ingest.api;
...
public interface IngestService extends JobProducer {
   ...
   * <code>org.opencast.workflow.default.definition</code> key, found in the system configuration.
   *
   ...
   *           if the current user does not have {@link org.opencast.security.api.Permissions.Action#READ} on the
