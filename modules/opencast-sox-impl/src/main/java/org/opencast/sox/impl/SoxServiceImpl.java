...
import org.opencast.sox.api.SoxException;
...
public class SoxServiceImpl extends AbstractJobProducer implements SoxService, ManagedService {
  ...
  public static final String CONFIG_SOX_PATH = "org.opencast.sox.path";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.sox.api.SoxService#analyze(Track)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.sox.api.SoxService#normalize(Track, Float)
   */
  @Override
