 ...
 *
 */
package org.opencast.security.impl.jpa;
...
public class JpaOrganization implements Organization {
  ...
  /**
   * @see org.opencast.security.api.Organization#getId()
   */
  @Override
  public String getId() {
    return id;
  ...
  /**
   * @see org.opencast.security.api.Organization#getAnonymousRole()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Organization#getAdminRole()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Organization#getName()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Organization#getProperties()
   */
  @Override
  ...
  /**
   * @see org.opencast.security.api.Organization#getServers()
   */
  @Override
