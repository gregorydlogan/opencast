 ...
 */
@XmlType(name = "operation-definition", namespace = "http://workflow.opencast.org")
@XmlRootElement(name = "operation-definition", namespace = "http://workflow.opencast.org")
...
public class WorkflowOperationDefinitionImpl implements WorkflowOperationDefinition {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationDefinition#getExceptionHandlingWorkflow()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationDefinition#isFailWorkflowOnException()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationDefinition#getConfigurationKeys()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationDefinition#getRetryStrategy()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationDefinition#getMaxAttempts()
   */
  @Override
