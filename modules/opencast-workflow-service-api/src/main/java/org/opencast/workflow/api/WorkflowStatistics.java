...
@XmlRootElement(name = "statistics", namespace = "http://workflow.opencast.org")
@XmlType(name = "statistics", namespace = "http://workflow.opencast.org")
public class WorkflowStatistics {
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlRootElement(name = "definition_report", namespace = "http://workflow.opencast.org")
  @XmlType(name = "definition_report", namespace = "http://workflow.opencast.org")
  public static class WorkflowDefinitionReport {
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlRootElement(name = "operation_report", namespace = "http://workflow.opencast.org")
    @XmlType(name = "operation_report", namespace = "http://workflow.opencast.org")
