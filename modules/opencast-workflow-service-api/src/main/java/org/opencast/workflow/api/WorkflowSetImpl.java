...
@XmlRootElement(name = "workflows", namespace = "http://workflow.opencast.org")
public class WorkflowSetImpl implements WorkflowSet {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowSet#getItems()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowSet#size()
   */
  @Override
  public long size() {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowSet#getStartPage()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowSet#getPageSize()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowSet#getSearchTime()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowSet#getTotalCount()
   */
  @Override
