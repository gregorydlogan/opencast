...
public class WorkflowOperationResultImpl implements WorkflowOperationResult {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationResult#getMediaPackage()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationResult#getAction()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationResult#getProperties()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationResult#getTimeInQueue()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationResult#allowsAbort()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationResult#allowsContinue()
   */
  @Override
