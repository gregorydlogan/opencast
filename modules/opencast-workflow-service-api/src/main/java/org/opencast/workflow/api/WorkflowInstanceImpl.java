...
import static org.opencast.workflow.api.WorkflowOperationInstance.OperationState.FAILED;
import static org.opencast.workflow.api.WorkflowOperationInstance.OperationState.INSTANTIATED;
import static org.opencast.workflow.api.WorkflowOperationInstance.OperationState.RETRY;
import static org.opencast.workflow.api.WorkflowOperationInstance.OperationState.SKIPPED;
import static org.opencast.workflow.api.WorkflowOperationInstance.OperationState.SUCCEEDED;
...
@XmlType(name = "workflow", namespace = "http://workflow.opencast.org")
@XmlRootElement(name = "workflow", namespace = "http://workflow.opencast.org")
...
public class WorkflowInstanceImpl implements WorkflowInstance {
  ...
  @XmlElement(name = "creator", namespace = "http://org.opencast.security")
  private User creator;

  @XmlJavaTypeAdapter(OrganizationAdapter.class)
  @XmlElement(name = "organization", namespace = "http://org.opencast.security")
  private JaxbOrganization organization;

  @XmlElement(name = "mediapackage", namespace = "http://mediapackage.opencast.org")
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getId()
   */
  @Override
  public long getId() {
    return id;
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getTitle()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getCreator()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getOrganization()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getDescription()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getState()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getCurrentOperation()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getOperations()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#getMediaPackage()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#setMediaPackage(org.opencast.mediapackage.MediaPackage)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.Configurable#getConfiguration(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.Configurable#getConfigurationKeys()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.Configurable#removeConfiguration(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.Configurable#setConfiguration(java.lang.String, java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#next()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#hasNext()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowInstance#extend(org.opencast.workflow.api.WorkflowDefinition)
   */
  @Override
