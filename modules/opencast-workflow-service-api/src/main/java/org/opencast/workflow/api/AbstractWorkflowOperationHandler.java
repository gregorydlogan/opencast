...
public abstract class AbstractWorkflowOperationHandler implements WorkflowOperationHandler {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationHandler#skip(org.opencast.workflow.api.WorkflowInstance,
   *      JobContext)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationHandler#destroy(org.opencast.workflow.api.WorkflowInstance,
   *      JobContext)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationHandler#getId()
   */
  @Override
  public String getId() {
    return id;
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowOperationHandler#getDescription()
   */
  @Override
   ...
   *
   * @deprecated use {@link #getConfig(WorkflowInstance, String)} or {@link #getOptConfig(org.opencast.workflow.api.WorkflowInstance, String)}
   */
  ...
  /**
   * Set the @link org.opencast.job.api.JobBarrier polling interval.
   * <p>
   ...
   *
   * @see org.opencast.job.api.JobBarrier#DEFAULT_POLLING_INTERVAL
   */
