...
public interface WorkflowOperationInstance extends Configurable {
   ...
   * {@link org.opencast.workflow.api.WorkflowInstance.WorkflowState#STOPPED}. A return value of
   ...
   *
   * @return a strategy from {@link org.opencast.workflow.api.RetryStrategy}.
   */
