 ...
 */
@XmlType(name = "definition", namespace = "http://workflow.opencast.org")
@XmlRootElement(name = "definition", namespace = "http://workflow.opencast.org")
...
public class WorkflowDefinitionImpl implements WorkflowDefinition {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#getId()
   */
  public String getId() {
    return id;
  }
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#setId(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#getDescription()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#setDescription(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#getConfigurationPanel()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#getOperations()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#get(int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#add(org.opencast.workflow.api.WorkflowOperationDefinition)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.workflow.api.WorkflowDefinition#remove(int)
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.api.WorkflowDefinition#addTag(String)
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.api.WorkflowDefinition#removeTag(String)
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.api.WorkflowDefinition#containsTag(String)
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.api.WorkflowDefinition#containsTag(Collection)
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.api.WorkflowDefinition#getTags()
   */
  @Override
  ...
  /**
   * @see org.opencast.workflow.api.WorkflowDefinition#clearTags()
   */
  @Override
