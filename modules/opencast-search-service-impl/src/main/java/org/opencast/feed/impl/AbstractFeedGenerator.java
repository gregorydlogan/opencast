...
import org.opencast.feed.api.Content.Mode;
...
import org.opencast.feed.api.FeedGenerator;
...
public abstract class AbstractFeedGenerator implements FeedGenerator {
  ...
  public static final String PROP_ORG_ENGAGE_UI_URL = "org.opencast.engage.ui.url";

  /** Property key for the organizations feed url */
  public static final String PROP_ORG_FEED_URL = "org.opencast.feed.url";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.api.FeedGenerator#initialize(java.util.Properties)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.api.FeedGenerator#getIdentifier()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.api.FeedGenerator#getName()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.api.FeedGenerator#getDescription()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.api.FeedGenerator#getCopyright()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.api.FeedGenerator#getCover(Organization)
   */
  @Override
