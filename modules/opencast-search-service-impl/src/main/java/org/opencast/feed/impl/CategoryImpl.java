...
public class CategoryImpl implements Category {
  ...
  /**
   * @see org.opencast.feed.api.Category#getName()
   */
  ...
  /**
   * @see org.opencast.feed.api.Category#getTaxonomyUri()
   */
  ...
  /**
   * @see org.opencast.feed.api.Category#setName(java.lang.String)
   */
  ...
  /**
   * @see org.opencast.feed.api.Category#setTaxonomyUri(java.lang.String)
   */
