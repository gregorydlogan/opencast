...
import org.opencast.feed.api.Feed.Type;
...
public class SeriesFeedService extends AbstractFeedService implements FeedGenerator {
  ...
  /**
   * @see org.opencast.feed.api.FeedGenerator#accept(java.lang.String[])
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.impl.AbstractFeedGenerator#getIdentifier()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.impl.AbstractFeedGenerator#getName()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.impl.AbstractFeedGenerator#getDescription()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.impl.AbstractFeedGenerator#loadFeedData(org.opencast.feed.api.Feed.Type,
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.feed.impl.AbstractFeedService#initialize(java.util.Properties)
   */
  @Override
