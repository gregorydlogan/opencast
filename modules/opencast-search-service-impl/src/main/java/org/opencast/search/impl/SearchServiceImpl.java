...
package org.opencast.search.impl;
...
import org.opencast.metadata.mpeg7.Mpeg7CatalogService;
import org.opencast.search.api.SearchException;
import org.opencast.search.api.SearchQuery;
import org.opencast.search.api.SearchResult;
import org.opencast.search.api.SearchService;
import org.opencast.search.impl.persistence.SearchServiceDatabase;
import org.opencast.search.impl.persistence.SearchServiceDatabaseException;
import org.opencast.search.impl.solr.SolrIndexManager;
import org.opencast.search.impl.solr.SolrRequester;
...
import org.opencast.solr.SolrServerFactory;
...
public final class SearchServiceImpl extends AbstractJobProducer implements SearchService, ManagedService {
  ...
  public static final String CONFIG_SOLR_URL = "org.opencast.search.solr.url";

  /** Configuration key for an embedded solr configuration and data directory */
  public static final String CONFIG_SOLR_ROOT = "org.opencast.search.solr.dir";

  /** The job type */
  public static final String JOB_TYPE = "org.opencast.search";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchService#getByQuery(java.lang.String, int, int)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchService#add(org.opencast.mediapackage.MediaPackage)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchService#delete(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchService#getByQuery(org.opencast.search.api.SearchQuery)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchService#getForAdministrativeRead(org.opencast.search.api.SearchQuery)
   */
  @Override
