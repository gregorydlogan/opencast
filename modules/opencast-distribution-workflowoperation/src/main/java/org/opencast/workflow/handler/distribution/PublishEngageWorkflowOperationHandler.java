...
import static org.opencast.systems.MatterhornConstants.SERVER_URL_PROPERTY;
import static org.opencast.util.data.Option.option;
import static org.opencast.util.data.functions.Strings.toBool;
import static org.opencast.util.data.functions.Strings.trimToNone;
import static org.opencast.workflow.handler.distribution.EngagePublicationChannel.CHANNEL_ID;
...
public class PublishEngageWorkflowOperationHandler extends AbstractWorkflowOperationHandler {
  ...
  private static final String ENGAGE_URL_PROPERTY = "org.opencast.engage.ui.url";
  private static final String STREAMING_URL_PROPERTY = "org.opencast.streaming.url";
