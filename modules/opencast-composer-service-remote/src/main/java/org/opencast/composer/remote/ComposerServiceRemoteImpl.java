...
package org.opencast.composer.remote;
...
import org.opencast.composer.api.EncodingProfileBuilder;
import org.opencast.composer.api.EncodingProfileImpl;
import org.opencast.composer.api.EncodingProfileList;
...
public class ComposerServiceRemoteImpl extends RemoteBase implements ComposerService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#trim(Track, String, long, long)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#image(Track, String, Map)
   */
  @Override
