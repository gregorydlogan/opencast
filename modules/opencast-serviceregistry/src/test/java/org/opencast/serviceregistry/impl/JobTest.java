...
import static org.opencast.util.data.Arrays.mkString;
import static org.opencast.util.data.Monadics.mlist;
import static org.opencast.util.data.functions.Booleans.eq;
...
import org.opencast.job.api.Job.FailureReason;
...
public class JobTest {
  ...
  public void testMarshallingWithXmlPayload() throws Exception {
    final String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<random xmlns:ns2=\"http://mediapackage.opencast.org\" xmlns:ns3=\"http://job.opencast.org/\">something</random>";
    Job job = new JobImpl();
    job.setPayload(payload);
