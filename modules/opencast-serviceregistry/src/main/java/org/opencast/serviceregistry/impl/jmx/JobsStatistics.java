...
package org.opencast.serviceregistry.impl.jmx;

import org.opencast.job.api.Job.Status;
import org.opencast.util.data.Tuple3;
...
public class JobsStatistics extends NotificationBroadcasterSupport implements JobsStatisticsMXBean {
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getJobCount()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getRunningJobCount()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getQueuedJobCount()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFinishedJobCount()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFailedJobCount()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getJobCountByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getRunningJobCountByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getQueuedJobCountByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFinishedJobCountByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFailedJobCountByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getAverageJobRunTime()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getAverageJobQueueTime()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getJobs()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getRunningJobs()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getQueuedJobs()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFinishedJobs()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFailedJobs()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getJobsByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getRunningJobsByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getQueuedJobsByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFinishedJobsByNode()
   */
  @Override
  ...
  /**
   * @see org.opencast.serviceregistry.impl.jmx.JobsStatisticsMXBean#getFailedJobsByNode()
   */
  @Override
