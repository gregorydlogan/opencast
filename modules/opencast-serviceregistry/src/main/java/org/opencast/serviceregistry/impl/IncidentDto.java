...
import static org.opencast.util.JsonVal.asString;
...
public class IncidentDto {
  ...
  /** @see org.opencast.job.api.Incident#getTimestamp() */
  public Date getTimestamp() {
    return timestamp;
  }

  /** @see org.opencast.job.api.Incident#getSeverity() */
  public Severity getSeverity() {
    return Severity.values()[severity];
  }

  /** @see org.opencast.job.api.Incident#getCode() */
  public String getCode() {
    return code;
  }

  /** @see org.opencast.job.api.Incident#getDetails() */
  ...
  /** @see org.opencast.job.api.Incident#getDescriptionParameters() */
