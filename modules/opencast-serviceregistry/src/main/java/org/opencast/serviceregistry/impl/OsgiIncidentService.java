...
import static org.opencast.util.IoSupport.loadPropertiesFromUrl;
...
public class OsgiIncidentService extends AbstractIncidentService implements BundleListener {
  ...
  public void bundleChanged(BundleEvent event) {
    switch (event.getType()) {
      ...
      case BundleEvent.UNINSTALLED:
        ...
        // from bundle-id -> text-base-keys, e.g. 125 -> "org.opencast.composer"
  ...
  private void storeIncidentTexts(Bundle bundle) {
    ...
    while (l10n != null && l10n.hasMoreElements()) {
      ...
      // e.g. org.opencast.composer.properties or org.opencast.composer_de.properties
      ...
      // part 0 contains the key base, e.g. org.opencast.composer
