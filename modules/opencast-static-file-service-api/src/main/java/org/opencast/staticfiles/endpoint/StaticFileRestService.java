...
package org.opencast.staticfiles.endpoint;
...
public class StaticFileRestService {
  ...
  public static final String STATICFILES_WEBSERVER_ENABLED_KEY = "org.opencast.staticfiles.webserver.enabled";

  /** The key to find the URL for where a webserver is hosting the static files. */
  public static final String STATICFILES_WEBSERVER_URL_KEY = "org.opencast.staticfiles.webserver.url";

  /** The key to find the maximum sized file to accept as an upload. */
  public static final String STATICFILES_UPLOAD_MAX_SIZE_KEY = "org.opencast.staticfiles.upload.max.size";
