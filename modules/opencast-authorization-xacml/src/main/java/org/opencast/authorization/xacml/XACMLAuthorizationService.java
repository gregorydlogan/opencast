...
package org.opencast.authorization.xacml;

import static org.opencast.mediapackage.MediaPackageElements.XACML_POLICY;
import static org.opencast.mediapackage.MediaPackageElements.XACML_POLICY_EPISODE;
import static org.opencast.mediapackage.MediaPackageElements.XACML_POLICY_SERIES;
import static org.opencast.util.IoSupport.withFile;
import static org.opencast.util.data.Collections.list;
import static org.opencast.util.data.Collections.mkString;
import static org.opencast.util.data.Monadics.caseA;
import static org.opencast.util.data.Monadics.caseN;
...
import org.opencast.util.data.Option.Match;
...
public class XACMLAuthorizationService implements AuthorizationService {
   ...
   * {@link org.opencast.mediapackage.MediaPackageElements#XACML_POLICY} flavor exists.
   */
  ...
  /** Functional version of {@link #toFlavors(org.opencast.security.api.AclScope)}. */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.AuthorizationService#hasPolicy(org.opencast.mediapackage.MediaPackage)
   */
  @Override
