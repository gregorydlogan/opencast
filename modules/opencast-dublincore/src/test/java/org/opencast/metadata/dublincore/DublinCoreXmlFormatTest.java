...
import org.opencast.util.Xpath;
...
public class DublinCoreXmlFormatTest {
  ...
  public void readFromStringWithXmlHeader() throws Exception {
    final String xml =
        "<?xml version=\"1.0\"?>\n"
            + "<dublincore xmlns=\"http://www.opencast.org/xsd/1.0/dublincore/\"\n"
  ...
  public void readFromNode() throws Exception {
    ...
    final NamespaceContext ctx = XmlNamespaceContext.mk(
        XmlNamespaceBinding.mk("inlined", "http://www.opencast.org/oai/matterhorn-inlined"),
        XmlNamespaceBinding.mk("mp", "http://mediapackage.opencast.org"),
