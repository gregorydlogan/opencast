...
package org.opencast.metadata.dublincore;
...
import static org.opencast.metadata.dublincore.DublinCore.ENC_SCHEME_URI;
import static org.opencast.metadata.dublincore.DublinCore.LANGUAGE_ANY;
import static org.opencast.metadata.dublincore.DublinCore.LANGUAGE_UNDEFINED;
...
import static org.opencast.metadata.dublincore.DublinCore.PROPERTY_FORMAT;
...
import static org.opencast.metadata.dublincore.DublinCore.TERMS_NS_URI;
import static org.opencast.metadata.dublincore.DublinCores.OC_PROPERTY_PROMOTED;
...
import org.opencast.mediapackage.NamespaceBindingException;
import org.opencast.metadata.api.MediaPackageMetadata;
import org.opencast.util.MimeType;
import org.opencast.util.UnknownFileTypeException;
...
public class DublinCoreTest {
  ...
  /**
   * Test method for {@link org.opencast.metadata.dublincore.DublinCoreCatalog#fromFile(java.io.File)} .
   */
  @Test
  ...
  public void testNewInstance() {
    try {
      ...
      dcNew.add(PROPERTY_LICENSE, DublinCoreValue.mk("http://www.opencast.org/license",
              DublinCore.LANGUAGE_UNDEFINED, ENC_SCHEME_URI));
      // Don't forget to bind the namespace...
      dcNew.addBindings(XmlNamespaceContext.mk("octest", "http://www.opencast.org/octest"));
      dcNew.add(OC_PROPERTY_PROMOTED, DublinCoreValue.mk("true", DublinCore.LANGUAGE_UNDEFINED,
              new EName("http://www.opencast.org/octest", "Boolean")));
      try {
        dcNew.add(OC_PROPERTY_PROMOTED, DublinCoreValue.mk("true", DublinCore.LANGUAGE_UNDEFINED,
                EName.mk("http://www.opencast.org/enc-scheme", "Boolean")));
        fail();
  ...
  public void testPreserveEncodingScheme() {
    DublinCoreCatalog dc = DublinCores.mkOpencastEpisode().getCatalog();
    DublinCoreValue val = DublinCoreValue.mk("http://www.opencast.org/license", "en", ENC_SCHEME_URI);
  ...
  public void testForNullsInDublinCoreCatalogImpl() throws Exception {
    ...
    try {
      ...
      dc.add(EasyMock.createNiceMock(org.opencast.mediapackage.EName.class), val);
    } catch (Exception e) {
    ...
    try {
      String val2 = null;
      dc.add(EasyMock.createNiceMock(org.opencast.mediapackage.EName.class), val2);
    } catch (Exception e) {
      // throw assertion if it happens to be a nullpointer, never a null pointer!
      Assert.assertFalse(e instanceof NullPointerException);
    }
    ...
    try {
      String val2 = null;
      dc.add(EasyMock.createNiceMock(org.opencast.mediapackage.EName.class), val2, val2);
    } catch (Exception e) {
      // throw assertion if it happens to be a nullpointer, never a null pointer!
      Assert.assertFalse(e instanceof NullPointerException);
    }
