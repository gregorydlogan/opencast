...
@XmlType(name = "preview", namespace = "http://search.opencast.org")
@XmlRootElement(name = "preview", namespace = "http://search.opencast.org")
public class MediaSegmentPreviewImpl implements MediaSegmentPreview {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegmentPreview#getReference()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegmentPreview#getUrl()
   */
  @Override
