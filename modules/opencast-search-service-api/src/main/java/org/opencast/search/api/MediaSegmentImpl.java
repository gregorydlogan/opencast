...
@XmlType(name = "segment", namespace = "http://search.opencast.org")
@XmlRootElement(name = "segment", namespace = "http://search.opencast.org")
public class MediaSegmentImpl implements MediaSegment, Comparable<MediaSegmentImpl> {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#getIndex()
   */
  public int getIndex() {
    return number;
  }
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#getTime()
   */
  public long getTime() {
    return time;
  }
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#getDuration()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#getImageUrl()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#getText()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#isHit()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#getRelevance()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.MediaSegment#addPreview(java.lang.String, java.lang.String)
   */
  @Override
