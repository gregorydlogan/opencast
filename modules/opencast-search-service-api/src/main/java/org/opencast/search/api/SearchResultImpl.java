...
@XmlType(name = "search-results", namespace = "http://search.opencast.org", propOrder = { "query", "resultSet" })
@XmlRootElement(name = "search-results", namespace = "http://search.opencast.org")
public class SearchResultImpl implements SearchResult {
  ...
  static {
    try {
      context = JAXBContext.newInstance("org.opencast.search.api", SearchResultImpl.class.getClassLoader());
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#getItems()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#getQuery()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#size()
   */
  public long size() {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#getOffset()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#getLimit()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#getSearchTime()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#getTotalSize()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.search.api.SearchResult#getPage()
   */
  public long getPage() {
    if (limit != 0)
      return offset / limit;
