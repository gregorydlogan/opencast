...
import org.opencast.annotation.api.AnnotationList;
 ...
 */
@XmlType(name = "annotations", namespace = "http://annotation.opencast.org")
@XmlRootElement(name = "annotations", namespace = "http://annotation.opencast.org")
