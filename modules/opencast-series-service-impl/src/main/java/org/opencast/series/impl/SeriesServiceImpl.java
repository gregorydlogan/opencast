...
import static org.opencast.util.EqualsUtil.eqListSorted;
...
import org.opencast.util.data.FunctionException;
...
public class SeriesServiceImpl extends AbstractIndexProducer implements SeriesService {
   ...
   * (non-Javadoc)
   *
   * @see org.opencast.series.api.SeriesService#deleteSeries(java.lang.String)
   */
  @Override
