...
package org.opencast.series.impl.solr;
...
import org.opencast.series.impl.SeriesServiceIndex;
...
public class SeriesServiceSolrIndex implements SeriesServiceIndex {
  ...
  public static final String CONFIG_SOLR_URL = "org.opencast.series.solr.url";

  /** Configuration key for an embedded solr configuration and data directory */
  public static final String CONFIG_SOLR_ROOT = "org.opencast.series.solr.dir";
   ...
   *
   * @see
   * org.opencast.series.impl.SeriesServiceIndex#index(org.opencast.metadata.dublincore.DublinCoreCatalog)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.opencast.series.impl.SeriesServiceIndex#count()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.opencast.series.impl.SeriesServiceIndex#get(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.opencast.series.impl.SeriesServiceIndex#getAccessControl(java.lang.String)
   */
  @Override
