...
public class SecurityServiceSpringImpl implements SecurityService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.SecurityService#getOrganization()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.SecurityService#setOrganization(Organization)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.SecurityService#getUser()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.SecurityService#setUser(User)
   */
  @Override
