...
package org.opencast.kernel.security;

import static org.opencast.kernel.rest.CurrentJobFilter.CURRENT_JOB_HEADER;
import static org.opencast.kernel.security.DelegatingAuthenticationEntryPoint.DIGEST_AUTH;
import static org.opencast.kernel.security.DelegatingAuthenticationEntryPoint.REQUESTED_AUTH_HEADER;
import static org.opencast.util.OsgiUtil.getOptContextProperty;

import org.opencast.kernel.http.api.HttpClient;
...
import org.opencast.security.util.HttpResponseWrapper;
import org.opencast.security.util.StandAloneTrustedHttpClientImpl;
import org.opencast.serviceregistry.api.ServiceRegistry;
import org.opencast.urlsigning.utils.ResourceRequestUtil;
...
public class TrustedHttpClientImpl implements TrustedHttpClient, HttpConnectionMXBean {
  ...
  public static final String DIGEST_AUTH_USER_KEY = "org.opencast.security.digest.user";

  /** The configuration property specifying the digest authentication password */
  public static final String DIGEST_AUTH_PASS_KEY = "org.opencast.security.digest.pass";

  /** The configuration property specifying the number of times to retry after the nonce timesouts on a request. */
  public static final String NONCE_TIMEOUT_RETRY_KEY = "org.opencast.security.digest.nonce.retries";
  ...
  protected static final String INTERNAL_URL_SIGNING_DURATION_KEY =
    "org.opencast.security.internal.url.signing.duration";

  /**
   * The configuration property specifying the minimum amount of time in seconds wait before retrying a request after a
   * nonce timeout.
   */
  public static final String NONCE_TIMEOUT_RETRY_BASE_TIME_KEY = "org.opencast.security.digest.nonce.base.time";
  ...
  public static final String NONCE_TIMEOUT_RETRY_MAXIMUM_VARIABLE_TIME_KEY =
    "org.opencast.security.digest.nonce.variable.time";
  ...
  public void activate(ComponentContext cc) {
    ...
    try {
      ...
      ObjectName name;
      name = new ObjectName("org.opencast.security.api.TrustedHttpClient:type=HttpConnections");
      Object mbean = this;
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.TrustedHttpClient#execute(org.apache.http.client.methods.HttpUriRequest)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.TrustedHttpClient#close(org.apache.http.HttpResponse)
   */
  @Override
