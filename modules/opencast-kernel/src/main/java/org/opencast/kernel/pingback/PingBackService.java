...
package org.opencast.kernel.pingback;
...
public class PingBackService {
  ...
  public void activate(ComponentContext cc) {
    ...
    final String pingbackUrl = bundleContext.getProperty("org.opencast.anonymous.feedback.url");
        ...
        pingbackTimer.schedule(new TimerTask() {
          public void run() {
            ...
            try {
              ...
              logger.info("Unable to send system configuration to opencast.org: {}", e.getMessage());
            } finally {
