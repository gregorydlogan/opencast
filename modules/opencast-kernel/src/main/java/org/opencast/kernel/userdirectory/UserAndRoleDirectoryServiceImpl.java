...
package org.opencast.kernel.userdirectory;

import static org.opencast.security.api.UserProvider.ALL_ORGANIZATIONS;
...
import org.opencast.security.api.RoleDirectoryService;
...
public class UserAndRoleDirectoryServiceImpl implements UserDirectoryService, UserDetailsService, RoleDirectoryService {
  ...
  public static final String USER_CACHE_SIZE_KEY = "org.opencast.userdirectory.cache.size";

  /** The configuration property for the user cache expiry time */
  public static final String USER_CACHE_EXPIRY_KEY = "org.opencast.userdirectory.cache.expiry";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.UserDirectoryService#getUsers()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.security.api.UserDirectoryService#loadUser(java.lang.String)
   */
  @Override
