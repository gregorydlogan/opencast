...
package org.opencast.staticfiles.jmx;
...
public class UploadStatistics implements UploadStatisticsMXBean {
  ...
  /**
   * @see org.opencast.staticfiles.jmx.UploadStatisticsMXBean#getSuccessfulUploadOperations()
   */
  @Override
  ...
  /**
   * @see org.opencast.staticfiles.jmx.UploadStatisticsMXBean#getFailedUploadOperations()
   */
  @Override
  ...
  /**
   * @see org.opencast.staticfiles.jmx.UploadStatisticsMXBean#getTotalBytes()
   */
  @Override
  ...
  /**
   * @see org.opencast.staticfiles.jmx.UploadStatisticsMXBean#getBytesInLastMinute()
   */
  @Override
  ...
  /**
   * @see org.opencast.staticfiles.jmx.UploadStatisticsMXBean#getBytesInLastFiveMinutes()
   */
  @Override
  ...
  /**
   * @see org.opencast.staticfiles.jmx.UploadStatisticsMXBean#getBytesInLastFifteenMinutes()
   */
  @Override
