...
package org.opencast.userdirectory.sakai;
...
public class SakaiUserProviderFactory implements ManagedServiceFactory {
  ...
  public static final String PID = "org.opencast.userdirectory.sakai";

  /** The key to look up the organization identifer in the service configuration properties */
  private static final String ORGANIZATION_KEY = "org.opencast.userdirectory.sakai.org";

  /** The key to look up the user DN to use for performing searches. */
  private static final String SAKAI_SEARCH_USER = "org.opencast.userdirectory.sakai.user";

  /** The key to look up the password to use for performing searches */
  private static final String SEARCH_PASSWORD = "org.opencast.userdirectory.sakai.password";

  /** The key to look up the regular expression used to validate sites */
  private static final String SITE_PATTERN_KEY = "org.opencast.userdirectory.sakai.site.pattern";

  /** The key to look up the regular expression used to validate users */
  private static final String USER_PATTERN_KEY = "org.opencast.userdirectory.sakai.user.pattern";

  /** The key to look up the number of user records to cache */
  private static final String CACHE_SIZE = "org.opencast.userdirectory.sakai.cache.size";

  /** The key to look up the URL of the Sakai instance */
  private static final String SAKAI_URL_KEY = "org.opencast.userdirectory.sakai.url";

  /** The key to look up the list of Instructor roles on the Sakai instance */
  private static final String SAKAI_INSTRUCTOR_ROLES_KEY = "org.opencast.userdirectory.sakai.instructor.roles";

  /** The key to look up the number of minutes to cache users */
  private static final String CACHE_EXPIRATION = "org.opencast.userdirectory.sakai.cache.expiration";
