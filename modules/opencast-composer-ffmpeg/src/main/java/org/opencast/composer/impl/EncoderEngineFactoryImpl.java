...
import org.opencast.composer.impl.ffmpeg.FFmpegEncoderEngine;
...
public class EncoderEngineFactoryImpl implements EncoderEngineFactory {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncoderEngineFactory#newEncoderEngine(org.opencast.composer.api.EncodingProfile)
   */
  @Override
