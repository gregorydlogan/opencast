...
package org.opencast.composer.impl.episode;

import org.opencast.composer.api.EncoderException;
import org.opencast.composer.api.EncodingProfile;
import org.opencast.composer.impl.AbstractEncoderEngine;
...
public final class EpisodeEncoderEngine extends AbstractEncoderEngine {
  ...
  /**
   * @see org.opencast.composer.api.EncoderEngine#needsLocalWorkCopy()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncoderEngine#mux(java.io.File, java.io.File,
   *      org.opencast.composer.api.EncodingProfile, java.util.Map)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncoderEngine#encode(java.io.File,
   *      org.opencast.composer.api.EncodingProfile, java.util.Map)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.opencast.composer.api.EncoderEngine#extract(File, EncodingProfile, Map, double...)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.EncoderEngine#trim(java.io.File,
   *      org.opencast.composer.api.EncodingProfile, long, long, java.util.Map)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.impl.AbstractEncoderEngine#getOutputFile(java.io.File,
   *      org.opencast.composer.api.EncodingProfile)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.opencast.composer.api.EncoderEngine#extract(java.io.File,
   * org.opencast.composer.api.EncodingProfile, java.util.Map, long[])
   */
