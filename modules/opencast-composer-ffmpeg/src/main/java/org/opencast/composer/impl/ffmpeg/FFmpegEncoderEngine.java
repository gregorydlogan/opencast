...
public class FFmpegEncoderEngine extends AbstractCmdlineEncoderEngine {
  ...
  private static final String CONFIG_FFMPEG_PATH = "org.opencast.composer.ffmpeg.path";
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.impl.AbstractCmdlineEncoderEngine#trim(java.io.File,
