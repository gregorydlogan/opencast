...
import static org.opencast.fun.juc.Immutables.list;
import static org.opencast.serviceregistry.api.Incidents.NO_DETAILS;
...
import org.opencast.composer.api.EmbedderException;
import org.opencast.composer.api.EncoderEngine;
import org.opencast.composer.api.EncoderEngineFactory;
...
import org.opencast.composer.layout.Layout;
import org.opencast.composer.layout.Serializer;
import org.opencast.fun.juc.Mutables;
import org.opencast.inspection.api.MediaInspectionException;
...
import org.opencast.mediapackage.MediaPackageElementBuilder;
...
import org.opencast.mediapackage.Stream;
...
import org.opencast.mediapackage.identifier.IdBuilderFactory;
...
public class ComposerServiceImpl extends AbstractJobProducer implements ComposerService, ManagedService {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#encode(org.opencast.mediapackage.Track,
   *      java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#trim(org.opencast.mediapackage.Track,
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#mux(org.opencast.mediapackage.Track,
   *      org.opencast.mediapackage.Track, java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#image(Track, String, double...)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#convertImage(org.opencast.mediapackage.Attachment,
   *      java.lang.String)
   */
  @Override
   ...
   *
   * @see org.opencast.composer.api.ComposerService#captions(org.opencast.mediapackage.Track,
   *      org.opencast.mediapackage.Catalog[])
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#listProfiles()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.composer.api.ComposerService#getProfile(java.lang.String)
   */
  @Override
