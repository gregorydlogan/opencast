 ...
 *
 */
package org.opencast.scheduler.api;
...
public class RecordingImpl implements Recording {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.scheduler.api.Recording#getID()
   */
  @Override
  public String getID() {
    return id;
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.scheduler.api.Recording#setState(java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.scheduler.api.Recording#getState()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.scheduler.api.Recording#getLastCheckinTime()
   */
  @Override
