...
public class TimeImpl implements Time {
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.caption.api.Time#getHours()
   */
  @Override
  public int getHours() {
    return this.hours;
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.caption.api.Time#getMinutes()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.caption.api.Time#getSeconds()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencast.caption.api.Time#getMilliseconds()
   */
  @Override
