...
import org.opencast.matterhorn.search.Language;
...
public class SearchMetadataImpl<T> implements SearchMetadata<T> {
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#getName()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#isLocalized()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#getLocalizedValues()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#addValue(java.lang.Object)
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#getValues()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#getValue()
   */
  @Override
  public T getValue() {
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#setAddToText(boolean)
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchMetadata#clear()
   */
  public void clear() {
    if (values != null)
      values.clear();
