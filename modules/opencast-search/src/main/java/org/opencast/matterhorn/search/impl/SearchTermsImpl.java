...
public class SearchTermsImpl<T extends Object> implements SearchTerms<T> {
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchTerms#add(java.lang.Object)
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchTerms#getTerms()
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchTerms#contains(java.lang.Object)
   */
  @Override
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchTerms#size()
   */
  @Override
  public int size() {
    return terms.size();
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchTerms#getQuantifier()
   */
  @Override
