...
public class SearchResultImpl<T> implements SearchResult<T> {
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getItems()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getLimit()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getOffset()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getPage()
   */
  public long getPage() {
    if (offset == 0 || limit == 0)
      return 1;
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getPageSize()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getSearchTime()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getHitCount()
   */
   ...
   * {@inheritDoc}
   * 
   * @see org.opencast.matterhorn.search.SearchResult#getDocumentCount()
   */
