 ...
 *
 */
package org.opencast.assetmanager.api.fn;

import static com.entwinemedia.fn.Stream.$;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;
import static org.opencast.assetmanager.api.fn.Properties.mkProperty;
...
public class PropertiesTest {
  static final Property pb1 = mkProperty("mp-1", "org.opencast.approval", "approved", Value.mk(false));
  static final Property ps1 = mkProperty("mp-1", "org.opencast.approval", "comment", Value.mk("Bad audio"));
  static final Property pd1 = mkProperty("mp-2", "org.opencast.approval", "date", Value.mk(new Date(0)));
  static final Property ps2 = mkProperty("mp-3", "org.opencast.comment", "comment", Value.mk("Hello world"));
  static final Property pl1 = mkProperty("mp-3", "org.opencast.comment", "count", Value.mk(1L));
  ...
  @Parameters({
          "unknown.namespace | 0",
          "org.opencast.approval | 3",
          "org.opencast.comment | 2"})
  ...
  @Parameters({
          ...
          "org.opencast.approval | approved | 1",
          "org.opencast.approval | date | 1",
          "org.opencast.approval | comment | 1"})
  ...
  public void testGetStrings() throws Exception {
    ...
    assertEquals($("Hello world").toList(), ps.apply(Properties.getStrings(PropertyName.mk("org.opencast.comment", "comment"))).toList());
  }

  @Test
  public void testGetStringsNotFound() throws Exception {
    assertTrue(ps.apply(Properties.getStrings("unknown")).isEmpty());
    assertTrue(ps.apply(Properties.getStrings(PropertyName.mk("org.opencast.approval", "unknown"))).isEmpty());
  }
