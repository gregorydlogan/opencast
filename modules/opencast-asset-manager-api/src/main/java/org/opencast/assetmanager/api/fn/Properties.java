...
public final class Properties {
   ...
   * They'll appear in the order of the returned {@linkplain org.opencast.assetmanager.api.query.ARecord records}.
   */
   ...
   *
   * @deprecated make use of a {@link org.opencast.assetmanager.api.query.PropertySchema} instead of creating property IDs manually
   */
