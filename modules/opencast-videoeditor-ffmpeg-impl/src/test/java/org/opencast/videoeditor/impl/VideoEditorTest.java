...
package org.opencast.videoeditor.impl;

import static org.junit.Assert.assertNotNull;
import static org.junit.Assert.assertTrue;

import org.opencast.inspection.api.MediaInspectionException;
import org.opencast.inspection.ffmpeg.FFmpegAnalyzer;
...
import org.opencast.smil.entity.api.SmilBody;
import org.opencast.smil.entity.api.SmilHead;
import org.opencast.smil.entity.media.api.SmilMediaObject;
import org.opencast.smil.entity.media.container.api.SmilMediaContainer;
import org.opencast.smil.entity.media.element.api.SmilMediaElement;
...
import org.opencast.videoeditor.api.ProcessFailedException;
...
public class VideoEditorTest {
  ...
  public void setUp() throws Exception {
    ...
    EasyMock.expect(bc.getProperty("org.opencast.storage.dir")).andReturn(storageDir.getPath()).anyTimes();
    EasyMock.expect(bc.getProperty("org.opencast.composer.ffmpegpath")).andReturn(FFMPEG_BINARY).anyTimes();
    ...
    String sourceTrackXml = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?>"
            + "<track xmlns=\"http://mediapackage.opencast.org\" type='presentation/source' id='deadbeef-a926-4ba9-96d9-2fafbcc30d2a'>"
