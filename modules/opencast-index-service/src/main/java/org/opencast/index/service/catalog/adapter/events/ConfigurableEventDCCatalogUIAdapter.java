...
package org.opencast.index.service.catalog.adapter.events;

import static org.opencast.index.service.catalog.adapter.CatalogUIAdapterFactory.CONF_FLAVOR_KEY;
import static org.opencast.index.service.catalog.adapter.CatalogUIAdapterFactory.CONF_ORGANIZATION_KEY;
import static org.opencast.util.OsgiUtil.getCfg;

import org.opencast.index.service.catalog.adapter.CatalogUIAdapterConfiguration;
import org.opencast.index.service.catalog.adapter.DublinCoreMetadataCollection;
  ...
  public Catalog storeFields(MediaPackage mediaPackage, MetadataCollection abstractMetadata) {
    ...
    if (catalogs.length == 0) {
      catalog = (Catalog) MediaPackageElementBuilderFactory.newInstance().newElementBuilder()
              .newElement(org.opencast.mediapackage.MediaPackageElement.Type.Catalog, getFlavor());
