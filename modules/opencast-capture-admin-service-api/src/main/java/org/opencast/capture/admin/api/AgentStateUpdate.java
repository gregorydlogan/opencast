...
package org.opencast.capture.admin.api;

import org.opencast.util.HashtableAdapter;
 ...
 */
@XmlType(name = "agent-state-update", namespace = "http://capture.admin.opencast.org")
@XmlRootElement(name = "agent-state-update", namespace = "http://capture.admin.opencast.org")
...
public class AgentStateUpdate {
   ...
   * {@link org.opencast.capture.admin.api.AgentState}.
   *
   * @see AgentState
   */
