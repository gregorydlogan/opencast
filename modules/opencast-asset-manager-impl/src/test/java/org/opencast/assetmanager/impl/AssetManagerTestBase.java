...
import org.opencast.util.persistencefn.Queries;
 ...
 * <p>
 * See {@link org.opencast.util.persistencefn.PersistenceUtil#mkTestEntityManagerFactoryFromSystemProperties(String)}
...
public abstract class AssetManagerTestBase<A extends AssetManager> {
  ...
  public static final String PERSISTENCE_UNIT = "org.opencast.assetmanager.impl";
  ...
  public final void setUp(A assetManager) {
    am = assetManager;
    q = am.createQuery();
    p = new Props(q, "org.opencast.service");
    p2 = new Props(q, "org.opencast.service.sub");
  }
