 ...
 *
 */
package org.opencast.oaipmh.server;

import static java.lang.String.format;
import static org.opencast.oaipmh.OaiPmhUtil.toOaiRepresentation;
import static org.opencast.oaipmh.OaiPmhUtil.toUtc;
import static org.opencast.oaipmh.persistence.QueryBuilder.queryRepo;
import static org.opencast.oaipmh.server.Functions.addDay;
import static org.opencast.oaipmh.server.Functions.asDate;
...
import org.opencast.oaipmh.Granularity;
import org.opencast.oaipmh.OaiPmhConstants;
import org.opencast.oaipmh.OaiPmhUtil;
...
//        return oai(request(), verb(setNodes));
   ...
   * {@link org.opencast.oaipmh.server.OaiPmhRepository.ListItemsEnv.ListXmlGen} for the XML generation.
   */
  abstract class ListItemsEnv {
    ...
    public XmlGen apply(final Params p) {
      ...
      final Function<Date, Date> untilAdjustment = getRepositoryTimeGranularity() == Granularity.DAY ? addDay(1)
              : org.opencast.util.data.functions.Functions.<Date>identity();
