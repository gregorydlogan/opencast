...
import org.opencast.oaipmh.TestUtil;
import org.opencast.oaipmh.util.PersistenceEnv;
import org.opencast.oaipmh.util.PersistenceUtil;
...
public class LastHarvestedTest {
  ...
  private PersistenceEnv newPenv() {
    EntityManagerFactory emf = TestUtil.newTestEntityManagerFactory("org.opencast.oaipmh.harvester");
