...
import static org.opencast.kernel.userdirectory.InMemoryUserAndRoleProvider.PROVIDER_NAME;

import org.opencast.security.api.Organization;
import org.opencast.security.api.OrganizationDirectoryListener;
...
public class AdminUserAndGroupLoader implements OrganizationDirectoryListener {
  ...
  public static final String OPT_ADMIN_USER = "org.opencast.security.admin.user";

  /** The administrator password configuration option */
  public static final String OPT_ADMIN_PASSWORD = "org.opencast.security.admin.pass";

  /** The administrator email configuration option */
  public static final String OPT_ADMIN_EMAIL = "org.opencast.admin.email";

  /** The administrator roles configuration option */
  public static final String OPT_ADMIN_ROLES = "org.opencast.security.admin.roles";
